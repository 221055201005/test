...
<form id='form-submit' action="<?php echo base_url(); ?>irn/submit_irn_fab" enctype="multipart/form-data" method='POST' id="form_submition">
        ...
        <div class="my-3 p-3 bg-white rounded shadow-sm">
          ...
          <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-md <?= $get['project'] == 21 ? null : 'd-none' ?>" id="div_deck">
                  <div class="form-group row">
              ...
              <div class="row">
                <div class="col-md">
                  <div class="form-group row">
                    <label class="col-xl-3 col-form-label">Drawing GA :</label>
                    <div class="col-xl">
              ...
              <div class="row">
                <div class="col-md">
                  <div class="form-group row">
                    <label class="col-xl-3 col-form-label"> Part ID :</label>
                    <div class="col-xl">
                      <select class='select2_multiple_itr' name='part_id[]' id='part_id' multiple>
                      </select>
                  ...
                  <div class="col-1">
                    <div class="form-group row">
                      <div class="col-xl">
                        ...
                        <input type='hidden' name='smoe_approval_by' value='<?= $data_piecemark_list[0]['irn_smoe_approval_by'] ?>'>
                        <input type='hidden' name='smoe_approval_date' value='<?= $data_piecemark_list[0]['irn_smoe_approval_date'] ?>'>
                        <input type='hidden' name='smoe_remarks' value='<?= $data_piecemark_list[0]['irn_smoe_remarks'] ?>'>
                        <input type='hidden' name='client_approval_by' value='<?= $data_piecemark_list[0]['irn_client_approval_by'] ?>'>
                        <input type='hidden' name='client_approval_date' value='<?= $data_piecemark_list[0]['irn_client_approval_date'] ?>'>
                        <input type='hidden' name='client_remarks' value='<?= $data_piecemark_list[0]['irn_client_remarks'] ?>'>
                        <input type='hidden' name='transmittal_by' value='<?= $data_piecemark_list[0]['irn_transmittal_by'] ?>'>
                        <input type='hidden' name='transmittal_date' value='<?= $data_piecemark_list[0]['irn_transmittal_date'] ?>'>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      $(".select2_multiple_itr").select2({
        tokenSeparators: [',', ' '],
        ajax: {
          url: "<?php echo base_url(); ?>irn/display_search_part_id_select2",
          type: "post",
          dataType: 'json',
          data: function(params) {
            var query = {
              ...
              company_id: $("select[name='company_id_joint']").find('option:selected').val(),
              deck_elevation: $("select[name='deck_elevation']").find('option:selected').val(),
              project_value: $("select[name='project_joint']").find('option:selected').val(),
    ...
    function autodrawingByjoint(input) {
      var project_value = $("select[name='project_joint']").find('option:selected').val();
      var discipline_value = $("select[name='discipline_joint']").find('option:selected').val();
      var module_value = $("select[name='module_joint']").find('option:selected').val();
      var type_of_module_value = $("select[name='type_of_module_joint']").find('option:selected').val();
      var company_id_value = $("select[name='company_id_joint']").find('option:selected').val();
      var deck_elevation_value = $("select[name='deck_elevation']").find('option:selected').val();

      $(input).autocomplete({
        source: function(request, response) {
          $.post('<?php echo base_url(); ?>irn/display_drawing_material', {
            term: request.term,
            discipline_value: discipline_value,
            module_value: module_value,
            type_of_module_value: type_of_module_value,
            company_id_value: company_id_value,
            project_value: project_value,
            deck_elevation_value: deck_elevation_value,
          }, response, 'json');
        },
        autoFocus: true,
        classes: {
  ...
  <script type="text/javascript">
    ...
    function auto_part_id(input) {
      ...
      $(input).autocomplete({
        source: function(request, response) {
          $.post('<?php echo base_url(); ?>irn/display_part_id_new', {
            term: request.term,
            drawing_no: drawing_no,
            discipline: discipline_value,
            module: module_value,
            type_of_module: type_of_module_value,
    ...
    $(function() {
      ...
      $("#addRowBtn").click(function() {
        ...
        var company_id_val = $("select[name='company_id_joint']").find('option:selected').val();
        ...
        if (drawing_joint_val === "") {
          ...
          return false;
        } else if (company_id_val === "") {
          alert("Please Choice Company ID..");
          return false;
        } else if (part_id_val === "") {
          alert("Please type Part ID..");
          return false;
        } else {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>irn/validated_part_id",
            type: "post",
            data: {
                ...
                for (var i = 0; i <= data_all.length; i++) {
                  ...
                  var html = `
                    <tr>
                      <td>
                        ${res[7]}
                        <input type='hidden' name='id_piecemark[]' value='${res[0]}'> 
    ...
    function addrow_pnc() {
      ...
      <tr id="remove_pnc${count_data_pnc}">
        <td class="align-middle">
          <input type="text" class="form-control" name="pnc_desc[${count_data_pnc}]" id="pnc_desc[${count_data_pnc}]" placeholder='Description' >
        </td>
