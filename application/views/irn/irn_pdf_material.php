...
<body>
    ...
    <table border="1px" style="border-collapse: collapse !important;width:100% !important;">
        <tr>
            ...
            <?php } ?>
            <td style="padding: 5px;vertical-align: middle !important;">RFI NO :
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: middle !important;"><b><?php echo (isset($show_pcms_irn_description[0]['rfi_date']) ? date("F d, Y", strtotime(@$show_pcms_irn_description[0]['rfi_date'])) : null) ?></b></td>
        </tr>
        <tr>
    ...
    <table border="1px" style="border-collapse: collapse !important;width: 703px !important;">
        ...
        <tr>
            <td colspan="22" style="text-align:left; padding:10px !important; ">
                <table class='table_content' width="100%" cellspacing="0" cellpadding="0" style=' border: none !important;font-size:80% !important;'>
                    <tr>
        ...
        <tr>
            <td style="text-align:left;padding-bottom:30px;">
                <b>Comment/Remarks :<br /><br />
                    <?= isset($show_pcms_irn[0]['client_remarks']) ? $show_pcms_irn[0]['client_remarks'] : '-' ?>
            </td>
        </tr>
        <tr>
                ...
                <td style=" ">SIGNATURE<br />
                    <center>
                        <div style="page-break-inside: avoid;">
                            ...
                            <?php else : ?>
                                <?php if (isset($user[$show_pcms_irn[0]['client_approval_by']]['sign_approval'])) { ?>
                                    <img src="data:image/png;base64,<?= $user[$show_pcms_irn[0]['client_approval_by']]['sign_approval'] ?>" style="width: 100px !important; height: 50px !important">
                                <?php } ?>
                            <?php endif; ?>
                        </div>
                    </center>
    ...
    <table border="1px" style="border-collapse: collapse !important;width: 703px !important;">
        <tr>
            ...
            <td style="padding: 5px;vertical-align: middle !important;width: 20% !important;">
                <b>DATE :</b>
                <br /><?php echo (isset($show_pcms_irn_description[0]['rfi_date']) ? date("F d, Y", strtotime(@$show_pcms_irn_description[0]['rfi_date'])) : null) ?>
    ...
    <!-- item for releases -->
    <table border="1px" style="border-collapse: collapse !important;width: 703px !important;font-size:80%">
        <tr>
    ...
    <table border="1px" style="border-collapse: collapse !important;width: 703px !important;">
        <tr>
            <td style="text-align:left;padding-bottom:30px;">
                <b>Comment/Remarks :<br /><br />
                    <?php echo @$show_pcms_irn_detail[0]['remarks'] ?>
            </td>
        </tr>
    </table>
    ...
    <div id='page3'>
        ...
        <table border="1px" style="border-collapse: collapse !important;width:700px !important;">
            <tr>
            ...
            <tr>
                <td valign="middle" style="padding: 5px;width: 70% !important;vertical-align: middle !important;">
                    <center>
        ...
        <br />
        <table border="1px" style="border-collapse: collapse !important;width: 700px !important;text-align:center;font-size:80% !important;">
            <thead>
                <tr>
            ...
            <tbody>
                <?php foreach ($show_data_irn_list as $key => $value) { ?>
                    ...
                    $drawing_mv            = strtr($this->encryption->encrypt($status_piecemark[$value['part_id']]['drawing_no']), '+=/', '.-~');
                    ...
                    if ($show_pcms_irn[0]['is_itr'] == 1) {
                        ...
                        if (isset($status_piecemark[$value['part_id']]['status_inspection'])) {
                            if ($status_piecemark[$value['part_id']]['status_inspection'] >= 3) {
                                if (isset($status_piecemark[$value['part_id']]['report_number'])) {
                                    $status_inspection_p1 = '<a target="_blank" href="' . base_url() . 'material_verification/material_verification_pdf_client/' . $project_id . '/' . $discipline . '/' . $type_of_module . '/' . $module . '/' . $report_no . '/' . $report_no_rev . '/' . $drawing_mv . '">COMPLETED</a>';
                                } else {
