                ...
                <td width="40%">
                    <table class='title_desc' width="100%">
                        <thead>
                            ...
                            <tr>
                                <th style='text-align:left !important;'>JOB NUMBER</th>
                                <th>:</th>
                                <th style='text-align:left !important;'><?= $wtr_list[0]['job_no'] ?></th>
                            </tr>
                            <tr>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="padding:2px !important;" <?= (in_array($pc_pos_1['status_inspection'], $array_qc_approval) && isset($pc_pos_1['status_inspection']) ? "class='color_pending_QC'" : null) ?>>
                                ...
                                foreach ($data_multiple_piecemark_1 as $vaxx) {
                                    if (isset($status_piecemark_ref_1[$vaxx])) {
                                        ...
                                        if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number']) and $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['status_inspection'] == 7) {
                                            echo $report_no_mv[$status_piecemark[$value["pos_1"]]["company_id"]][$value['project']][$status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'];
                                        } else {
                                            if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'])) {
                                                echo $report_no_mv[$status_piecemark[$value["pos_1"]]["company_id"]][$value['project']][$pc_pos_1['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'];
                                            } else {
                                                echo "-";
                                            }
                                        }
                                        ...
                                        if ($status_piecemark_ref_1_itr[$vaxx]['report_number']) {
                                            ...
                                            $report_number  = $report_no_itr[$status_piecemark[$value["pos_1"]]["company_id"]][$value['project']][$pc_pos_1['discipline']][$value['type_of_module']]['itr_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_scm' : '')] . '-' . $report_number;
                                        }
                            ...
                            <?php } else { ?>
                                ...
                                <?php if (isset($pc_pos_1['report_number']) and $pc_pos_1['status_inspection'] >= 3) { ?>
                                    ...
                                    $report_number_1  = @$report_no_mv[$status_piecemark[$value["pos_1"]]["company_id"]][$value['project']][$pc_pos_1['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $pc_pos_1['report_number'];
                                    ...
                                    if ($itr_pos_1) {
                                        $report_number_1  = @$report_no_itr[$status_piecemark[$value["pos_1"]]["company_id"]][$value['project']][$pc_pos_1['discipline']][$value['type_of_module']]['itr_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_scm' : '')] . "-" . $pc_pos_1['report_number'];
                        ...
                        <td style="padding:2px !important;" <?= (in_array($pc_pos_2['status_inspection'], $array_qc_approval) && isset($pc_pos_2['status_inspection']) ? "class='color_pending_QC'" : null) ?>>
                            ...
                            <?php if (isset($status_piecemark_ref[$value['pos_2']]["ref_pos_1"]) && !empty($status_piecemark_ref[$value['pos_2']]["ref_pos_1"])) { ?>
                                ...
                                foreach ($data_multiple_piecemark_1 as $vaxx) {
                                    if (isset($status_piecemark_ref_1[$vaxx])) {
                                        ...
                                        if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number']) and $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['status_inspection'] == 7) {
                                            echo $report_no_mv[$status_piecemark[$value["pos_2"]]["company_id"]][$value['project']][$status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_2"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'];
                                        } else {
                                            if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'])) {
                                                echo $report_no_mv[$status_piecemark[$value["pos_2"]]["company_id"]][$value['project']][$pc_pos_2['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_2"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'];
                                            } else {
                                                echo "-";
                                            }
                                        }
                                        ...
                                        if ($status_piecemark_ref_1_itr[$vaxx]['report_number']) {
                                            $report_number  = $status_piecemark_ref_1_itr[$vaxx]['report_number'];
                                            $report_number  = $report_no_itr[$status_piecemark[$value["pos_2"]]["company_id"]][$value['project']][$pc_pos_2['discipline']][$value['type_of_module']]['itr_no' . ($status_piecemark[$value["pos_2"]]["company_id"] == 13 ? '_scm' : '')] . '-' . $report_number;
                                        }
                            ...
                            <?php } else { ?>
                                ...
                                <?php if (isset($pc_pos_2['report_number']) and $pc_pos_2['status_inspection'] >= 3) { ?>
                                    ...
                                    $report_number_2  = @$report_no_mv[$status_piecemark[$value["pos_2"]]["company_id"]][$value['project']][$pc_pos_2['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_2"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $pc_pos_2['report_number'];
                                    ...
                                    if ($itr_pos_2) {
                                        $report_number_2  = @$report_no_itr[$status_piecemark[$value["pos_2"]]["company_id"]][$value['project']][$pc_pos_2['discipline']][$value['type_of_module']]['itr_no' . ($status_piecemark[$value["pos_2"]]["company_id"] == 13 ? '_scm' : '')] . "-" . $pc_pos_2['report_number'];
                        ...
                        <td style="padding:2px !important;">
                            <?php
                            if ($value["process_gtaw_rh"] > 0) {
                                echo "GTAW <br/>";
                            }
                            if ($value["process_gmaw_rh"] > 0) {
                                echo "GMAW <br/>";
                            }
                            if ($value["process_smaw_rh"] > 0) {
                                echo "SMAW <br/>";
                            }
                            if ($value["process_fcaw_rh"] > 0) {
                                echo "FCAW <br/>";
                            }
                            if ($value["process_saw_rh"]  > 0) {
                                echo "SAW <br/>";
                            }
                            ?>
                        </td>
                        ...
                        <td style="padding:2px !important;">
                            <?php
                            if ($value["process_gtaw_fc"] > 0) {
                                echo "GTAW <br/>";
                            }
                            if ($value["process_gmaw_fc"] > 0) {
                                echo "GMAW <br/>";
                            }
                            if ($value["process_smaw_fc"] > 0) {
                                echo "SMAW <br/>";
                            }
                            if ($value["process_fcaw_fc"] > 0) {
                                echo "FCAW <br/>";
                            }
                            if ($value["process_saw_fc"]  > 0) {
                                echo "SAW <br/>";
                            }
                            ?>
                        </td>
                        ...
                        <td style="padding:2px !important;" <?= (in_array($value['visual_status_inspection'], $array_qc_approval) && !empty($value['visual_status_inspection']) ? "class='color_pending_QC'" : null) ?>>
                            ...
                            <?php if (isset($value['visual_report_no']) and $value['visual_status_inspection'] >= 3) {  ?>
                                ...
                                <?php if ($value['visual_status_inspection'] != 5) { ?>
                                    ...
                                    <?php echo $report_no_vs[$value['company_id']][$value['project']][$value['discipline']][$value['type_of_module']]['visual_report' . ($value['company_id'] == 13 ? '_13' : '')] . $value['visual_report_no']; ?>
                        ...
                        <td style="padding:2px !important;">
                            <?= (isset($value["irn_report_no"]) ? $report_no_irn[$value['company_id']][$value['project']][$value['discipline']][$value['type_of_module']]['irn_report' . ($value['company_id'] == 13 ? '_scm' : '')] . $value["irn_report_no"] : (isset($value["irn_submission_id"]) ? "Draft" : "-")) ?>
                        </td>
                        ...
                        <td style="padding:2px !important;"><?php if (isset($pc_pos_1['id_mis'])) {
