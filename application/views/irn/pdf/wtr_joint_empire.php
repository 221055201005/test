    ...
    <table class="wtr">
      <thead>
        <tr>
          ...
          <th colspan="<?= $wtr_list[0]['discipline'] != 1 ? "88"  : "16" ?>" style="padding:2px !important;">Non Destructive Examination</th>
          ...
          <?php } ?>
          <?php if ($wtr_list[0]['discipline'] == 1) { ?>
            <th rowspan="3" style="width:50px !important" style="padding:2px !important;">Deck Elevation</th>
          <?php } ?>
      ...
      <tbody>
        ...
        ?>
            ...
            <td><?= $value['pt_percent_req'] == '' ? '-' : $value['pt_percent_req'] . '%' ?></td>
              <td style="padding:2px !important;">
                ...
                ?>
                  ...
                  <a target="_blank"><?= @$val02['report_number'] ?></a>
          ...
          <td><?= $value['rt_percent_req'] == '' ? '-' : $value['rt_percent_req'] . '%' ?></td>
            ...
            <?php } ?>
            <?php if ($wtr_list[0]['discipline'] == 1) { ?>
              <td style="padding:2px !important;"><?php echo $deck_array[$value['deck_elevation']]['name']; ?></td>
            <?php } ?>
