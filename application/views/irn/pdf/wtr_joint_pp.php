                ...
                ?>
                  ...
                  ?>
                    ...
                    <tr>
                          ...
                          <?php    
                            ...
                            if(sizeof($tack_weld_id) > 0){ 
                              foreach ($tack_weld_id as $key => $tack_weld_id_name) {
                                if(isset($master_welder[$tack_weld_id_name]["welder_code"])){ echo $master_welder[$tack_weld_id_name]["welder_code"]."<br/>"; }
                              }
                            } 
                          ?>
                        </td>
                        ...
                        <td style="padding:2px !important;"><?php if(isset($pc_pos_1['id_mis'])){ echo str_replace("\n","<br/>",$value["visual_remarks"]); } ?></td>
