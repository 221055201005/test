<html>
                 <body>
                    <p>Dear All,</b></p>
                    <p>The following Email contain Inspection Invitation for IRN Progress.</p>
                        ...
                        <td>
                          <table style='padding:20px !important;'>
                            <tr style='font-weight:bold;'>
                              <td>RFI No</td>
                              <td>:</td>
                              <td><?= $rfi_no_mail ?> <?php if(isset($irn_revision_email)){ echo "Rev. ".$irn_revision_email; } ?></td>
                            </tr>
                            <tr>
                              <td>Report No</td>
                              <td>:</td>
                              <td><?= $report_no_mail ?> <?php if(isset($irn_revision_email)){ echo "Rev. ".$irn_revision_email; } ?></td>
                            </tr>
                            <tr>
