                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xl">
                          <select class="form-control select2" name="company_id" required>
                            ...
                            <!-- <?php //if($this->user_cookie[11] == 13){ 
                                  ?>    
                            <option value='13' selected>SMOP</option> 
                            <option value='1' selected>PT SMOE</option> 
                           <?php //} else { 
                            ?>   -->
                            ...
                            <?php if ($this->user_cookie[7] != 8) { ?>
                              ...
                              <?php foreach ($company_list as $key => $value) { ?>
                                <option value='<?= $value['id_company'] ?>' <?= ($value['id_company'] == @$post['company_id'] ? "selected" : ($value['id_company'] == $this->user_cookie[11] ? "selected" : "")) ?>>
                                  <?= $value['company_name'] ?>
                                </option>
                              <?php } ?>
                            ...
                            <?php } else { ?>
                              ...
                              <option value='13' <?= @$post["company_id"] == 13 ? "selected" : null ?>>SMOP</option>
                              <option value='1' <?= @$post["company_id"] == 1 ? "selected" : null ?>>PT SMOE</option>
                ...
                <tbody>
                  ...
                  foreach ($irn_list as $key => $value) { ?>
                    <tr>
                      ...
                      <?php } ?>
                      <td><?=
                          (isset($value['report_number']) ? $master_report_number[$value['project']][$value['discipline']][$value['type_of_module']][$value['irn_type']]["irn_report"] . $value['report_number'] : "Draft-" . $value['submission_id'])
                          ?>
                      <td>
                        <?php
                        if ($value['irn_type'] == 1) {
                      ...
                      <td style='width:200px !impontant;' <?php if ($this->permission_cookie['157'] == 1) { ?> contenteditable='true' onfocus="edit_data_irn(this)" onblur="change_desc_document_func('<?= $value['submission_id'] ?>', this)" <?php } ?>>
                      ...
                      <td>
                        <?php if ($value['third_party_approval_status'] == 0) { ?>
                          <span class="badge badge-warning badge-pill">Pending Review</span>
                        <?php } else if ($value['third_party_approval_status'] == 1) {  ?>
                        ...
                        <div class="btn-group-horizontal">
                          ...
                          <?php } else { ?>
                            <?php if ($category_irn == 0) { ?>
                              ...
                              <?php if ($this->permission_cookie[0] == 1 || in_array($this->user_cookie[0], $array_edit_irn)) { ?>
                                ...
                                <?php if ($this->permission_cookie[129] == 1 && @!in_array($value['status_inspection'], array("7"))  || $value['company_id'] == 13) { ?>
                              ...
                              <a href='<?php echo  base_url(); ?>irn/show_irn_detail/<?php echo strtr($this->encryption->encrypt($value['submission_id']), '+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt("report_no"), '+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($status_inspection), '+=/', '.-~') ?>'>
                                <span class='btn btn-secondary'><i class="far fa-file-alt"></i></span>
                              </a>
