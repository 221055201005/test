    ...
    <table width="100%">
      <tr>
        ...
        <td style="padding: 10px; border-right: 0px !important; border-left: 0px !important;">
          <center>
            <b style="font-weight: bold; font-size: 20px !important; vertical-align: middle !important;">
              <?php echo $loop_val["project"] == '17' ? 'Changhua Offshore Windfarm Project' : $project_client_description[$loop_val["project"]] ?>
            </b>
          </center>
        </td>
          ...
          <tr>
                ...
                foreach ($data_multiple_piecemark_1 as $vaxx) {
                  ...
                  if (isset($status_piecemark_ref_1[$vaxx])) {
                    ...
                    if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number']) and $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['status_inspection'] == 7) {
                      echo "<a href='" . base_url() . "material_verification/material_verification_pdf_client/" . $project_id_enc . "/" . $discipline_enc_material_1 . "/" . $type_of_module_enc . "/" . $module_enc . "/" . strtr($this->encryption->encrypt($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number']), '+=/', '.-~') . "/" . strtr($this->encryption->encrypt($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_no_rev']), '+=/', '.-~') . "' target='_blank'>" . "<span class='badge'>" . $report_no_mv[$value['project']][$status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'] . "</span></a><br/><br/>";
                    } else {
                      if (isset($status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'])) {
                        echo "<span class='badge'>" . $report_no_mv[$value['project']][$pc_pos_1['discipline']][$value['type_of_module']]['mv_no' . ($status_piecemark[$value["pos_1"]]["company_id"] == 13 ? '_smop' : '')] . "-" . $status_piecemark[$status_piecemark_ref_1[$vaxx]["part_id"]]['report_number'] . "</span><br/><br/>";
                      } else {
                        echo "-";
                      }
                    }
            ...
            <td style="padding:2px !important;">
              ...
              <?php } else { ?>
                <?php
                if (isset($pc_pos_1['id_mis'])) {
                  if ($warehouse_mis_mrir[$pc_pos_1['id_mis']]) {
                    $cert_name = $att_rec[$rec_det[$warehouse_mis_mrir[$pc_pos_1['id_mis']]["receiving_detail_id"]]['receiving_id']][$warehouse_mis_mrir[$pc_pos_1['id_mis']]["mill_cert_no"]];
                    if ($cert_name) {
                      $enc_path_cert  = encrypt("/PCMS/warehouse/receiving");
                      $enc_cert_name  = encrypt($cert_name);
                      $mill_cert    = '<a href="' . site_url('public_smoe/open_file_syn/' . $enc_cert_name . '/' . $enc_path_cert) . '" target="_blank">' . $warehouse_mis_mrir[$pc_pos_1['id_mis']]['heat_or_series_no'] . '</a>';
            ...
            <td style="padding:2px !important;">
              ...
              <?php } else { ?>
                ...
                if (isset($pc_pos_2['id_mis'])) {
                  ...
                  if ($warehouse_mis_mrir[$pc_pos_2['id_mis']]) {
                    $cert_name = $att_rec[$rec_det[$warehouse_mis_mrir[$pc_pos_2['id_mis']]["receiving_detail_id"]]['receiving_id']][$warehouse_mis_mrir[$pc_pos_2['id_mis']]["mill_cert_no"]];
                    if ($cert_name) {
                      $enc_path_cert  = encrypt("/PCMS/warehouse/receiving");
                      $enc_cert_name  = encrypt($cert_name);
                      $mill_cert    = '<a href="' . site_url('public_smoe/open_file_syn/' . $enc_cert_name . '/' . $enc_path_cert) . '" target="_blank">' . $warehouse_mis_mrir[$pc_pos_2['id_mis']]['heat_or_series_no'] . '</a>';
            ...
            <td style="padding:2px !important;">
              ...
              foreach ($welder_rh as $values_weld_rh) {
                if ($master_welder[$values_weld_rh]) {
                  $welder_rh_merge[] = $master_welder[$values_weld_rh]['welder_code'];
                }
              }
            ...
            <td style="padding:2px !important;">
              ...
              foreach ($welder_fc as $values_weld_fc) {
                if ($master_welder[$values_weld_fc]) {
                  $welder_fc_merge[] = $master_welder[$values_weld_fc]['welder_code'];
                }
              }
              ...
              //     if(isset($master_welder[$welder_id_fc]["welder_code"])){ 
              //       echo $master_welder[$welder_id_fc]["welder_code"]."<br/>";
              //     }
              //   }
              // } 
              ?>
            ...
            <td style="padding:2px !important;">
              ...
              if (isset($ndt_all_2[$value['id_joint_visual']][2][$value['revision_category']][$value['revision']])) {
                foreach ($ndt_all_2[$value['id_joint_visual']][2][$value['revision_category']][$value['revision']] as $key02 => $val02) {
              ?>
                  <a href="<?= site_url("ndt_live/ndt_detail_mt" . "/" . encrypt($val02['uniq_id_report']) . '/' . encrypt('pdf')); ?>" target="_blank"><?= @$val02['report_number'] ?></a>
              <?php
                }
              } else {
                echo "-";
            ...
            <td style="padding:2px !important;">
              ...
              ?>
                  ...
                  <a href="<?= site_url("ndt_live/ndt_detail_pt" . "/" . encrypt($val02['uniq_id_report']) . '/' . encrypt('pdf')); ?>" target="_blank"><?= @$val02['report_number'] ?></a>
            ...
            <td style="padding:2px !important;">
              ...
              ?>
                  <?php //test_var($val02); 
                  ?>
                  <a href="<?= site_url("ndt_live/ndt_detail_ut" . "/" . encrypt($val02['uniq_id_report']) . '/' . encrypt('pdf')); ?>" target="_blank"><?= @$val02['report_number'] ?></a>
              <?php
                }
              } else {
                echo "-";
            ...
            <td style="padding:2px !important;">
              ...
              ?>
                  <a href="<?= site_url("ndt_live/ndt_detail_rt" . "/" . encrypt($val02['uniq_id_report']) . '/' . encrypt('pdf')); ?>" target="_blank"><?= @$val02['report_number'] ?></a>
              <?php
                }
              } else {
                echo "-";
