    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h6 class="card-title">Preview Update IRN Ecodoc</h6>
            <hr>
            <form action="<?= site_url('irn/proceed_update_ecodoc') ?>" method="post">
              <div class="row">
                <div class="col-md-12">
                        ...
                        <?php foreach ($sheet as $key => $value) : ?>
                          <?php if ($key > 1) : ?>
                            ...
                            <tr class="<?= $disabled ? 'alert-warning' : '' ?>">
                              ...
                              <td><?= $value['G'] ?></td>
                              <td>
                                <input type="text" name="ecodoc_no[<?= $key ?>]" id="" class="form-control" value="<?= $value['H'] ?>"  <?= $disabled ? 'disabled' : '' ?>>
                              </td>
                              <td>
                                <input type="text" name="book_volume[<?= $key ?>]" id="" class="form-control" value="<?= $value['I'] ?>"  <?= $disabled ? 'disabled' : '' ?>>
                              </td>
                              <td>
                                <ul>
