                        ...
                        <div class="row">
                            <div class="col">
                              <div class="card shadow my-3 rounded-0">
                                <div class="card-header">
                                  <h6 class="m-0">                                    
                                        <?php if($filter["project"] != "" AND $filter["module"] != "" AND $filter["type_of_module"] != "" AND $filter["discipline"] != "" AND $filter["deck_elevation"] == "" AND $filter["desc_assy"] == ""){ ?>

                                          Progress Measurement - Level 5 

                                          <?php $db_progress = "l5"; ?>

                                        <?php } else if($filter["project"] != "" AND $filter["module"] != "" AND $filter["type_of_module"] != "" AND $filter["discipline"] != "" AND $filter["deck_elevation"] != "" AND $filter["desc_assy"] == ""){ ?>

                                          Progress Measurement - Level 6

                                          <?php $db_progress = "l6"; ?>

                                        <?php } else if($filter["project"] != "" AND $filter["module"] != "" AND $filter["type_of_module"] != "" AND $filter["discipline"] != "" AND $filter["deck_elevation"] != "" AND $filter["desc_assy"] != ""){ ?>
                                        
                                          Progress Measurement - Level 7
