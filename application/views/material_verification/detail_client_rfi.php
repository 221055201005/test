        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            ...
            <?php if ($action == "update") : ?>
              <form action="<?= site_url('material_verification/proceed_re_transmit_data') ?>" enctype="multipart/form-data" method="post">
              <?php else : ?>
                <form action="<?= site_url('material_verification/proceed_approval_client') ?>" enctype="multipart/form-data" method="post">
                <?php endif; ?>
                ...
                <?php if ($action == "detail") : ?>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm">
                      <div class="btn-group">
                        <!-- //updatemahmud1 -->
                        <button type="button" class="btn btn-outline-success" onclick="change_status(this, 7, 'accept')">Accept All</button>
                        <?php if (in_array($this->user_cookie[10], array(19, 21))) { ?>
                          <button type="button" class="btn btn-outline-success" onclick="change_status(this, 7, 'witness')">Witness All</button>
                          <button type="button" class="btn btn-outline-success" onclick="change_status(this, 7, 'review')">Review All</button>
                        <?php } ?>
                        <!-- //updatemahmud1 -->

                        <button type="button" class="btn btn-outline-danger" onclick="change_status(this, 6)">Reject All</button>

                        <button type="button" class="btn btn-outline-secondary" onclick="change_status(this, 0)">Clear All</button>
                      </div>
                      <?php if ($this->user_cookie[7] == 8 || $this->permission_cookie[238] == 1) { ?>
                ...
                <input type="hidden" name="deck_elevation" value="<?= $main_data['deck_elevation'] ?>">
                          ...
                          <div class="table-responsive overflow-auto">
                            <table class="table table-hover text-center">
                              <thead class="bg-info text-white text-nowrap">
                                ...
                                <th>Drawing SP</th>
                                <?php if ($action == "update") : ?>
                                  <th class="bg-gray-table">SP revision No.</th>
                                <?php endif; ?>
                                <th>Piece Mark No</th>
                                <th>Drawing AS</th>
                                <th>Drawing CP</th>
                                    ...
                                    <tr class="tr_row">
                                      ...
                                      <td class="text-left text-nowrap">
                                        ...
                                        <?php else : ?>
                                          ...
                                          <?php elseif ($value['status_inspection'] == 7 && $value['add_comment'] == 2) : ?>
                                            <span class="badge badge-pill badge-success">Witnessed</span>
                                          <?php elseif ($value['status_inspection'] == 7 && $value['add_comment'] == 3) : ?>
                                          ...
                                          <?php else : ?>
                                            ...
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <input type="radio" class="form-check-input radio_button approve editable" name="approval[<?= $key ?>]" value="7" style="transform: scale(1.3);" onclick='add_comment_stat("accept",<?= $key ?>);'><b class="text-success">Accept</b>
                                              </label>
                                            </div>
                                            <input type='hidden' class='add_comment_status' name='add_comment[<?= $key ?>]' value=''>
                                            <?php if (in_array($this->user_cookie[10], array(19, 21))) { ?>
                                              <div class="form-check">
                                                <label class="form-check-label">
                                                  <input type="radio" class="form-check-input radio_button witness editable" name="approval[<?= $key ?>]" value="7" style="transform: scale(1.3);" onclick='add_comment_stat("witness",<?= $key ?>);'><b class="text-success">Witness</b>
                                                </label>
                                              </div>
                                              <div class="form-check">
                                                <label class="form-check-label">
                                                  <input type="radio" class="form-check-input radio_button review editable" name="approval[<?= $key ?>]" value="7" style="transform: scale(1.3);" onclick='add_comment_stat("review",<?= $key ?>);'><b class="text-success">Review</b>
                                                </label>
                                              </div>
                                            <?php } ?>
                                            <!-- //updatemahmud1 -->
                                            <div class="form-check d-none">
                                              <label class="form-check-label">
                                                <!-- //updatemahmud1 -->
                                                <input type="radio" class="form-check-input radio_button approve_comment" name="approval[<?= $key ?>]" value="9" style="transform: scale(1.3);" onclick='add_comment_stat(null,<?= $key ?>);'><b class="text-primary">Accepted And Released With Comment</b>
                                                <!-- //updatemahmud1 -->
                                              </label>
                                            </div>
                                            <div class="form-check">
                                              <label class="form-check-label">
                                                <!-- //updatemahmud1 -->
                                                <input type="radio" class="form-check-input radio_button reject editable" name="approval[<?= $key ?>]" value="6" style="transform: scale(1.3);" onclick='add_comment_stat(null,<?= $key ?>);'><b class="text-danger">Reject</b>
                                                <!-- //updatemahmud1 -->
                                              </label>
                                            </div>
                                            <div class="form-check d-none">
                                              <label class="form-check-label">
                                                <!-- //updatemahmud1 -->
                                                <input type="radio" class="form-check-input radio_button postponed" name="approval[<?= $key ?>]" value="10" style="transform: scale(1.3);" onclick='add_comment_stat(null,<?= $key ?>);'><b class="text-info">Postponed</b>
                                                <!-- //updatemahmud1 -->
                                              </label>
                                            </div>
                                            <div class="form-check d-none">
                                              <label class="form-check-label">
                                                <!-- //updatemahmud1 -->
                                                <input type="radio" class="form-check-input radio_button reoffer" name="approval[<?= $key ?>]" value="11" style="transform: scale(1.3);" onclick='add_comment_stat(null,<?= $key ?>);'><b class="text-warning">Re-Offer</b>
                                                <!-- //updatemahmud1 -->
                                              </label>
                                            </div>
                                            <!-- <div class="form-check">
                            <label class="form-check-label">
                              <input type="radio" class="form-check-input radio_button pending"
                                name="approval[<?= $key ?>]" value="4" style="transform: scale(1.3);"><b
                                class="text-info">Pending By QC</b>
                            </label>
                          </div> -->
                                          <?php endif; ?>
                                        <?php endif; ?>

                                        <?php if ($value['status_inspection'] == 5 && $value['latest_inspection_status'] == 7) : ?>
                                          <div class="row">
                                            <div class="col-md-12">
                                              <span style="font-size: 12px;"><strong><i>Re - Approval Due To Piecemark Updated</i></strong></span>
                                            </div>
                                            <div class="col-md-12"><span style="font-size: 12px;"><strong><i>Request Reason : <?= $revise_history[$revision_log_item[$value['id_piecemark']]['id_request_update']]['request_reason'] ?></i></strong></span></div>
                                          </div>
                                      ...
                                      <td>
                                        <textarea name="reject_client_remarks[<?= $key ?>]" class="form-control input_width remarks_pc" <?= $value['status_inspection'] != 0 ? 'disabled' : '' ?>><?= $value['status_inspection'] == 6 ? $remarks : '' ?></textarea>
                                      </td>
                                    </tr>
                                  <?php endif; ?>
                                <?php endforeach; ?>
