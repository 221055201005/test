<?php
  ...
  header("Content-Disposition: attachment; filename=Reject Remarks History Material Verification.xls");
?>
...
<table border="1" style="width:100%; border-collapse: collapse;">
  <tr>
    ...
    <td style="vertical-align: middle; font-weight: bold; text-align: center;">Piece Mark No</td>
  ...
  <?php $no = 1;foreach ($reject_list as $key => $value): ?> 
    ...
    <td style="vertical-align: middle; text-align: center;"><?= $project[$detail_material[$value['id_process']]['project_code']] ?></td>
    <td style="vertical-align: middle; text-align: center;"><?= $detail_material[$value['id_process']]['drawing_no'] ?></td>
    <td style="vertical-align: middle; text-align: center;"><?= $discipline_name[$detail_material[$value['id_process']]['discipline']] ?></td>
    <td style="vertical-align: middle; text-align: center;"><?= $module_type_name[$detail_material[$value['id_process']]['type_of_module']] ?></td>
    <td style="vertical-align: middle; text-align: center;"><?= $module_name[$detail_material[$value['id_process']]['module']] ?></td>
    <td style="vertical-align: middle; text-align: center;"><?= $piecemark[$detail_material[$value['id_process']]['id_piecemark']]['part_id'] ?></td>
