<form action="<?= site_url('material_verification/proceed_request_for_update') ?>" method="post">
  <input type="hidden" name="request_by" value="<?= $user_cookie[0] ?>">
  <input type="hidden" name="submission_id" value="<?= $material['submission_id'] ?>">
  <input type="hidden" name="last_inspect_by" value="<?= $material['inspection_by'] ?>">
  <div class="row">
    <div class="col-md-12">
