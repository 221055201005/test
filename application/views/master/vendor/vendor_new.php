          ...
          <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
            <div class="container-fluid">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="code_check(this);" name="code" placeholder="Code Vendor">                
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" oninput="description_check(this);" name="description" placeholder="Description Vendor">                
                </div>
              </div>
