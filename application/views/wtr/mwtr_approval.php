...
<div id="content" class="container-fluid">
        ...
        <div class="col">
          <div class="card shadow my-3 rounded-0">
            <div class="card-header">
              <a class="btn btn-primary" data-toggle="collapse" href="#collapseButton" role="button"
                aria-expanded="false" aria-controls="collapseButton">Filter &nbsp; <i
                  class="fas fa-angle-double-down"></i><i class="fas fa-angle-double-up"></i></a>
            </div>
                ...
                <form action="" method="POST">
                          ...
                          <select class="form-control" name="project" required>
                            <?php if ($this->permission_cookie[0] == 1) { ?>
                              ...
                              <?php foreach ($project_list as $key => $value): ?>
                                <option onclick="save_project()" value="<?php echo $value['id'] ?>" <?php echo (@$post['project'] == $value['id'] ? 'selected' : '') ?>>
                          ...
                          <select class="form-control" name="module">
                            ...
                            <?php foreach ($module_list as $key => $value): ?>
                              <option value="<?php echo $value['mod_id'] ?>"
                                data-chained="<?php echo $value['project_id'] ?>" <?php echo (@$post['module'] == $value['mod_id'] ? 'selected' : '') ?>><?php echo $value['mod_desc'] ?>
                              </option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                        ...
                        <div class="col-xl">
                          <select class="form-control" name="type_of_module">
                            ...
                            <?php foreach ($type_of_module_list as $key => $value): ?>
                              <option value="<?php echo $value['id'] ?>" <?php echo (@$post['type_of_module'] == $value['id'] ? 'selected' : '') ?>><?php echo $value['name'] ?>
                              </option>
                            <?php endforeach; ?>
                          </select>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xl">
                          <input type="text" class="form-control autocomplete_doc" name="drawing_no"
                            value="<?php echo @$post['drawing_no'] ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12 text-right">
                      <button class="mt-2 btn btn-sm btn-flat btn-info" id="searchButton"><i class="fas fa-search"></i>
                        Search</button>
                    </div>
                  </div>
                </form>
  ...
  <?php if ($status_inspection == 0) { ?>
    <form action='<?php echo base_url(); ?>wtr/submit_multiple_draft_mwtr' method='POST'>
      <?php if ($status_inspection == 0 && !empty($_POST)) { ?>
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div class="col">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <input type="date" name="submitted_date" class="form-control" <?= $disabled ?> required
                                  value="<?= $main[0]['submitted_date'] ? DATE('Y-m-d', strtotime($main[0]['submitted_date'])) : '' ?>">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <input type="date" name="inspection_date" class="form-control" required <?= $disabled ?>
                                  value="<?= $main[0]['inspection_date'] ? DATE('Y-m-d', strtotime($main[0]['inspection_date'])) : '' ?>">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <input type="date" name="inspection_date_to" class="form-control" required <?= $disabled ?>
                                  value="<?= $main[0]['inspection_date_to'] ? DATE('Y-m-d', strtotime($main[0]['inspection_date_to'])) : '' ?>">
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="col-xl">
                                <select class="select2 will_enable" name="location">
                                  ...
                                  <?php foreach ($location_v2 as $value_location) { ?>
                                    <option value="<?= $value_location['id'] ?>"
                                      data-chained="<?php echo $value_location['id_area'] ?>"><?= $value_location['name'] ?>
                                    </option>
                                  <?php } ?>
                                </select>
                              </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <input type="text" name="qty" class="form-control" <?= $disabled ?> required
                                  value="<?= $main[0]['qty'] ?>">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <input type='text' class='form-control' name="expected_time"
                                  value="<?= $rfi_detail[0]['expected_time'] ?>">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-xl">
                                <select class="form-control select2" style="width:100%" name="legend_inspection_auth[]"
                                  multiple="">
                        ...
                        <tbody>
                          ...
                          foreach ($wtr_list as $key => $value) { ?>
                            <tr>
                              <?php if (($status_inspection == 0 || $status_inspection == 3) && $status_inspection != "summary_rfi") { ?>
                                <td>
                                  <input type='checkbox' class='form-control' name='submit_multiple[]'
                                    value='<?= $value['uniq_id'] ?>'>
                                  ...
                                  <input type='hidden' class='form-control' name='type_of_module[]'
                                    value='<?= $value['type_of_module'] ?>'>
                                  <input type='hidden' class='form-control' name='company_id_wp[]'
                                    value='<?= $value['company_id_wp'] ?>'>
                                  <input type='hidden' class='form-control' name='submission_id[]'
                                    value='<?= $value['submission_id'] ?>'>
                                  <input type='hidden' class='form-control' name='drawing_no[]'
                                    value='<?= $value['drawing_no'] ?>'>
                                </td>
                              <?php } ?>
                              ...
                              <?php if ($status_inspection != 0 || $status_inspection == "summary_rfi") { ?>
                                <td>
                                  <?php echo $value['submission_id'] . '<strong> Rev. ' . intval($value['postpone_reoffer_no']) . '</strong>'; ?>
                                </td>
                              <?php } else { ?>
                              ...
                              <td>
                                <a target="_blank"
                                  href="<?= base_url() ?>wtr/rfi_pdf/<?= strtr($this->encryption->encrypt($value['uniq_id']), '+=/', '.-~') ?>"
                                  title='RFI PDF' class='btn btn-sm btn-danger'><i class="fa fa-file-pdf"></i></a>
                                <?php if ($value['discipline'] == 1) { ?>
                                  <a target='_blank'
                                    href='<?= base_url() ?>wtr/show_irn_detail_wtr_signed_piping/<?= strtr($this->encryption->encrypt($value['uniq_id']), '+=/', '.-~') ?>'><span
                                      class='btn btn-primary'><i class="fas fa-book"></i></span></a>
                                <?php } else { ?>
                                  <a target='_blank'
                                    href='<?= base_url() ?>wtr/show_irn_detail_wtr_signed/<?= strtr($this->encryption->encrypt($value['uniq_id']), '+=/', '.-~') ?>'><span
                                      class='btn btn-primary'><i class="fas fa-book"></i></span></a>
                                <?php } ?>

                                <?php if ($value["status_inspection"] == 1 and in_array($this->user_cookie[0], $this->allow_return)) { ?>
                                  <button type="button"
                                    onclick="return_btr(this, '<?= encrypt($value['submission_id']) ?>')" type="button"
