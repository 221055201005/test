...
<head>
	<title><?php echo $rfi['submission_id'] ?>.pdf</title>
	<style type="text/css">
		@page {
			margin: 0cm 0cm;
		}
...
<body>
		...
		<table border="1px" style="border-collapse: collapse !important;" width="100%">
			<tr>
				<td rowspan='3' valign="middle"
					style="padding: 5px;width: 260px !important;vertical-align: middle !important;">
					<center>
			...
			<tr>
				...
				<td style="padding: 5px;vertical-align: middle !important;"><b><?= $rfi['submission_id'] ?>
			...
			<tr>
				<td rowspan='3' valign="middle" style="padding: 5px;vertical-align: middle !important;">
					<center>
						<img src="<?php echo $project_list[$rfi['project']]['client_logo']; ?>" style="width: 120px;">
					</center>
				</td>
				<td style="padding: 5px;vertical-align: middle !important;">
				...
				<td style="padding: 5px;vertical-align: middle !important;">
					<b><?php
					echo date("F d, Y", strtotime($rfi['rfi_submitted_date']))
						?></b>
				</td>
			</tr>
			<tr>
	...
	<table border="1px" style="border-collapse: collapse !important;" width="100%">
		<?php
		$inspection_month = DATE('m', strtotime($rfi['rfi_inspect_date_from']));
		$inspection_month_to = DATE('m', strtotime($rfi['rfi_inspect_date_to']));

		$inspection_date = DATE('d', strtotime($rfi['rfi_inspect_date_from']));
		$inspection_date_to = DATE('d', strtotime($rfi['rfi_inspect_date_to']));

		$inspection_date_arr = array();

		$start = new DateTime(DATE('Y-m-d', strtotime($rfi['rfi_inspect_date_from'])));
		$end = new DateTime(DATE('Y-m-d', strtotime($rfi['rfi_inspect_date_to'])));
		...
		$date_arr[] = DATE('d', strtotime($rfi['rfi_inspect_date_to']));
		...
		<tr>
			<td colspan="22" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;"><b>RFI -
					INSPECTION
					NOTIFICATION</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(1, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>JAN</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(2, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>FEB</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(3, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>MAR</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(4, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>APR</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(5, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>MAY</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(6, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>JUN</b>
			</td>
			<td rowspan='2' style="text-align:center; padding-bottom: 4px;vertical-align: middle !important;"
				class="<?= (in_array(1, $inspection_date_arr) and !in_array(1, $blank)) ? 'bg-selected' : '' ?>">
				<b>1</b></td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(2, $inspection_date_arr) and !in_array(2, $blank)) ? 'bg-selected' : '' ?>">
				<b>2</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(3, $inspection_date_arr) and !in_array(3, $blank)) ? 'bg-selected' : '' ?>">
				<b>3</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(4, $inspection_date_arr) and !in_array(4, $blank)) ? 'bg-selected' : '' ?>">
				<b>4</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(5, $inspection_date_arr) and !in_array(5, $blank)) ? 'bg-selected' : '' ?>">
				<b>5</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(6, $inspection_date_arr) and !in_array(6, $blank)) ? 'bg-selected' : '' ?>">
				<b>6</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(7, $inspection_date_arr) and !in_array(7, $blank)) ? 'bg-selected' : '' ?>">
				<b>7</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(8, $inspection_date_arr) and !in_array(8, $blank)) ? 'bg-selected' : '' ?>">
				<b>8</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(9, $inspection_date_arr) and !in_array(9, $blank)) ? 'bg-selected' : '' ?>">
				<b>9</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(10, $inspection_date_arr) and !in_array(10, $blank)) ? 'bg-selected' : '' ?>">
				<b>10</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(11, $inspection_date_arr) and !in_array(11, $blank)) ? 'bg-selected' : '' ?>">
				<b>11</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(12, $inspection_date_arr) and !in_array(12, $blank)) ? 'bg-selected' : '' ?>">
				<b>12</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(13, $inspection_date_arr) and !in_array(13, $blank)) ? 'bg-selected' : '' ?>">
				<b>13</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(14, $inspection_date_arr) and !in_array(14, $blank)) ? 'bg-selected' : '' ?>">
				<b>14</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(15, $inspection_date_arr) and !in_array(15, $blank)) ? 'bg-selected' : '' ?>">
				<b>15</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(16, $inspection_date_arr) and !in_array(16, $blank)) ? 'bg-selected' : '' ?>">
				<b>16</b>
			</td>
		</tr>
		<tr>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(7, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>JUL</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(8, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>AUG</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(9, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>SEP</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(10, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>OCT</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(11, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>NOV</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= in_array(12, $inspection_month_arr_v2) ? 'bg-selected' : '' ?>">
				<b>DEC</b>
			</td>

			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(17, $inspection_date_arr) and !in_array(17, $blank)) ? 'bg-selected' : '' ?>">
				<b>17</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(18, $inspection_date_arr) and !in_array(18, $blank)) ? 'bg-selected' : '' ?>">
				<b>18</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(19, $inspection_date_arr) and !in_array(19, $blank)) ? 'bg-selected' : '' ?>">
				<b>19</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(20, $inspection_date_arr) and !in_array(20, $blank)) ? 'bg-selected' : '' ?>">
				<b>20</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(21, $inspection_date_arr) and !in_array(21, $blank)) ? 'bg-selected' : '' ?>">
				<b>21</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(22, $inspection_date_arr) and !in_array(22, $blank)) ? 'bg-selected' : '' ?>">
				<b>22</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(23, $inspection_date_arr) and !in_array(23, $blank)) ? 'bg-selected' : '' ?>">
				<b>23</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(24, $inspection_date_arr) and !in_array(24, $blank)) ? 'bg-selected' : '' ?>">
				<b>24</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(25, $inspection_date_arr) and !in_array(25, $blank)) ? 'bg-selected' : '' ?>">
				<b>25</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(26, $inspection_date_arr) and !in_array(26, $blank)) ? 'bg-selected' : '' ?>">
				<b>26</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(27, $inspection_date_arr) and !in_array(27, $blank)) ? 'bg-selected' : '' ?>">
				<b>27</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(28, $inspection_date_arr) and !in_array(28, $blank)) ? 'bg-selected' : '' ?>">
				<b>28</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(29, $inspection_date_arr) and !in_array(29, $blank)) ? 'bg-selected' : '' ?>">
				<b>29</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(30, $inspection_date_arr) and !in_array(30, $blank)) ? 'bg-selected' : '' ?>">
				<b>30</b>
			</td>
			<td style="text-align:center; padding-bottom: 4px;"
				class="<?= (in_array(31, $inspection_date_arr) and !in_array(31, $blank)) ? 'bg-selected' : '' ?>">
				<b>31</b>
			</td>
		</tr>
		<tr>
			<td colspan="22"
				style="text-align:left; padding-bottom: 4px; padding-left: 4px; font-size: 12px !important;">
				<b>Document Ref
					:<br>
		...
		<tr>
			<td colspan="22" style="text-align:left; padding-top: 2px; ">Discipline : &nbsp;&nbsp;
				<?php if ($rfi['discipline'] == '2') { ?><input type="checkbox" name="optiona" id="opta"
						checked /><?php } else { ?><input type="checkbox" name="optiona" id="opta" /><?php } ?><span
					class="checkboxtext"> &nbsp;&nbsp;STRUCTURAL&nbsp;&nbsp;&nbsp;&nbsp;</span>
				...
				<input type="checkbox" name="optiona" id="opta" /><span class="checkboxtext">
					&nbsp;&nbsp;MECHANICAL&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<?php if ($rfi['discipline'] == '1') { ?><input type="checkbox" name="optiona" id="opta"
						checked="" /><?php } else { ?><input type="checkbox" name="optiona" id="opta" /><?php } ?><span
					class="checkboxtext"> &nbsp;&nbsp;PIPING&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<span class="checkboxtext"><input type="checkbox" name="optiona"
						id="opta" />&nbsp;&nbsp;HVAC&nbsp;&nbsp;&nbsp;&nbsp;</span>
			</td>
		</tr>
		<tr>
			<td colspan="22" style="text-align:left; padding-bottom: 4px; font-size: 12px !important;">TYPE OF
				INSPECTION :
			</td>
		</tr>
		<tr>
				...
				<table width="100%">
					<tr>
						<td style="text-align:left; padding-bottom: 4px;">
							...
							<span class="checkboxtext">&nbsp;&nbsp;Material / Equipment
								Inspection&nbsp;&nbsp;&nbsp;&nbsp;</span>
						</td>
						<td style="text-align:left; padding-bottom: 4px;">
					...
					<tr>
						...
						<td style="text-align:left; padding-bottom: 4px; ">
							...
							<span class="checkboxtext"> &nbsp;&nbsp;Pre-Commisioning /
								Commisioning&nbsp;&nbsp;&nbsp;&nbsp;</span>
						</td>
					</tr>
					<tr>
						<td style="text-align:left; padding-bottom: 4px;">
							...
							<span class="checkboxtext"> &nbsp;&nbsp;Procedure
								Qualification&nbsp;&nbsp;&nbsp;&nbsp;</span>
						</td>
						<td style="text-align:left; padding-bottom: 4px;">
						...
						<td style="text-align:left; padding-bottom: 4px; ">
							...
							<span class="checkboxtext"> &nbsp;&nbsp;Blasting / Painting /
								Coating&nbsp;&nbsp;&nbsp;&nbsp;</span>
						</td>
						<td style="text-align:left; padding-bottom: 4px; ">
					...
					<tr>
						<td style="text-align:left; padding-bottom: 4px;">
							...
							<span class="checkboxtext"> &nbsp;&nbsp;Production Test Coupon
								Welding&nbsp;&nbsp;&nbsp;&nbsp;</span>
						</td>
						<td style="text-align:left; padding-bottom: 4px;">
		...
		<?php if (!empty($rfi)): ?>
			<tr>
				<td colspan="1"
					style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
					1</td>
				<td colspan="6"
					style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
					<?php echo $rfi['drawing_no']; ?> </td>
				<td colspan="7"
					style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
					<?php echo $drawing['title']; ?> </td>
				<td colspan="3"
					style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
					<?php
					if ($rfi['rfi_inspect_area'] != '') {
						echo $location_v2_list[$rfi['rfi_inspect_location']]['name'];
					} else {
						echo $area_v2_list[$rfi['rfi_inspect_area']]['area_name'];
					}
					?>
				</td>
				<td colspan="5"
					style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rfi['rfi_expected_time'] ?></td>
			</tr>
		<?php endif; ?>
		...
		<table border="1px" style="border-collapse: collapse !important;" width="100%">
			...
			<tr>
				<td colspan="3" style="padding-bottom: 4px; font-size: 13px !important;font-weight: bold;">
					<table width="100%">
						<tr>
							<td><input type="checkbox" <?php if (in_array(1, explode(';', $rfi['rfi_itp']))) {
								echo "checked";
							} ?> /> Hold Point</td>
							<td><input type="checkbox" <?php if (in_array(2, explode(';', $rfi['rfi_itp']))) {
								echo "checked";
							} ?> /> Witness</td>
							<td><input type="checkbox" <?php if (in_array(3, explode(';', $rfi['rfi_itp']))) {
								echo "checked";
							} ?> /> Monitoring</td>
							<td><input type="checkbox" <?php if (in_array(4, explode(';', $rfi['rfi_itp']))) {
								echo "checked";
							} ?> /> Review</td>
						</tr>
					</table>
	...
	<table  border="1px" style="border-collapse: collapse !important;" width="100%"> -->
			<tr>
				<td colspan="3" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;">
					<b>INSPECTION EXCECUTION RESULT</b></td>
			</tr>
			<tr>
				<td colspan="3"
					style="text-align:left; padding-bottom: 4px; font-size: 13px !important;font-weight: bold;text-align: center;">
					<input type="checkbox" name="optiona" id="opta" / <?= $transmittal['status_inspection'] == 7 ? 'checked' : '' ?>><span class="checkboxtext"> &nbsp;Accepted:&nbsp; </span>
					<input type="checkbox" name="optiona" id="opta" / <?= $transmittal['status_inspection'] == 9 ? 'checked' : '' ?>><span class="checkboxtext"> &nbsp;Accepted & Release With Comments : &nbsp;
					</span>
			...
			<tr>
				<td colspan="3"
					style="text-align:left; padding-bottom: 4px; font-size: 12px !important; min-height: 15px !important">
					<b>Comment/Remarks :<br /></b>
					&nbsp;&nbsp;&nbsp;&nbsp;<?= $dc_atc['remarks'] ?>
				</td>
			</tr>

			<tr>
				<td colspan="3" style="text-align:center; padding-bottom: 4px; font-size: 10px !important;"><b>SIGNATURE
						FOR INSPECTION EXECUTED</b></td>
			</tr>
		</table>
		<!-- </table>
	<br>
			...
			<?php for ($i = 0; $i < 4; $i++): ?>
				<tr>
					<?php foreach ($sign_list as $key => $value): ?>
						<?php if ($i == 0): ?>
							<td
								style="text-align:center; padding-bottom: 4px; font-size: 12px !important;text-align: center;font-weight: bold; width:33.33%;">
								<?= strtoupper($key) ?></td>
						<?php elseif ($i == 1): ?>
							<td style="padding-bottom: 4px; font-size: 10px !important;">NAME
								<b><?= @$user_list[$value['id_user']]['full_name'] ?></b></td>
						<?php elseif ($i == 2): ?>
							<td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
									
								<?php if (isset($user_list[$value['id_user']])): ?>
									<div style="page-break-inside: avoid;">
										<img src="data:image/png;base64,<?= @$user_list[$value['id_user']]['sign_approval'] ?>"
