            ...
            <div class="row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xl">
                    <select class="form-control" name="status">
                      ...
                      <option value="2" <?php echo (@$get['status'] == '2' ? 'selected' : '') ?>>Completed by PMT</option>
                      <option value="3" <?php echo (@$get['status'] == '3' ? 'selected' : '') ?>>Pending QC</option>
                      <option value="2|3" <?php echo (@$get['status'] == '2|3' ? 'selected' : '') ?>>Completed by PMT & Pending QC</option>
                      <option value="7" <?php echo (@$get['status'] == '7' ? 'selected' : '') ?>>Rejected QC</option>
                      <option value="6" <?php echo (@$get['status'] == '6' ? 'selected' : '') ?>>Approved QC</option>
                      <option value="4" <?php echo (@$get['status'] == '4' ? 'selected' : '') ?>>Client invitation</option>
                      <option value="10" <?php echo (@$get['status'] == '10' ? 'selected' : '') ?>>Review Document by Client</option>
                      <option value="4|10" <?php echo (@$get['status'] == '4|10' ? 'selected' : '') ?>>Client invitation & Review Document by Client</option>
                      <option value="8" <?php echo (@$get['status'] == '8' ? 'selected' : '') ?>>Rejected Client</option>
                      <option value="9" <?php echo (@$get['status'] == '9' ? 'selected' : '') ?>>Approved Client</option>
                      <!-- <option value="11" <?php echo (@$get['status'] == '11' ? 'selected' : '') ?>>Approved Client With Comment</option>
                      <option value="5" <?php echo (@$get['status'] == '5' ? 'selected' : '') ?>>SMOE Completed</option>
                      <option value="12" <?php echo (@$get['status'] == '12' ? 'selected' : '') ?>>Upload on PIMS</option> -->
                    </select>
                  </div>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group row">
                  ...
                  <div class="col-xl">
                    <input type="text" class="form-control" name="cert_id" value="<?php echo @$get['cert_id'] ?>">
                  </div>
                </div>
              </div>
              <div class="col-6">
      ...
      <div class="card shadow my-3 rounded-0">
        ...
        <div class="card-body bg-white">
          <div class="overflow-auto">
            <table id="mechanical_completion_list" class="table table-hover text-center dataTable">
          ...
          <div class="row">
            <?php if($this->permission_cookie[153] == 1): ?>
              <div class="col-md-auto">
                ...
                <form method="POST" action="<?php echo base_url() ?>mechanical_completion/mechanical_delete_process" onsubmit="save_id_checked(this)">
...
<script>
  ...
  function checkall(input) {
    $('#mechanical_completion_list tbody input[type=checkbox]').each(function(i, obj) {
  ...
  $('.dataTable').DataTable({
    ...
    "serverSide": true,
    "ajax": {
      "url": "<?php echo base_url();?>mechanical_completion/mechanical_completion_list_datatable",
      "type": "POST",
      "data":{
          "page" : 'list',
      <?php 
        if($this->input->get('submit')){
          ...
          if($this->input->get('cert_id') !== ''){
            echo '"cert_id": "'. $this->input->get('cert_id').'",';
          }
