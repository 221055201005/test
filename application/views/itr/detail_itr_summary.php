...
if ($main_data['company_id'] == 13) {
  $running_report = $report_no_format[$main_data['project_code']][$main_data['discipline']][$main_data['module']][$main_data['type_of_module']]['itr_no_smop'];
}
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            <h6 class="card-title">Inspection & Testing Report Detail - <strong><?= $running_report ?></strong></h6>
            <hr>
            <div class="row">
              <div class="col-md-6">
            ...
            <?php if ($action == "update") : ?>
              <form action="<?= site_url('itr/proceed_re_transmit_data') ?>" enctype="multipart/form-data" method="post">
              <?php else : ?>
                <form action="<?= site_url('itr/proceed_approval_client') ?>" enctype="multipart/form-data" method="post">
                <?php endif; ?>

                <?php if ($action == "detail") : ?>
                  <!-- <hr> -->
                  <div class="row">
                    <div class="col-md-12 col-sm <?= $main_data['status_inspection'] == 5 ? '' : 'd-none' ?> d-none">
                      <div class="btn-group">
                ...
                <div class="col-md-12">
                  <ul class="nav nav-pills border-bottom border-gray" id="myTab" role="tablist">
                    ...
                    <li class="nav-item <?= count($detail_data) == $total_approve ? '' : 'd-none' ?>">
                  ...
                  <div class="tab-content" id="myTabContent">
                                ...
                                foreach ($detail_data as $key => $value) : ?>
                                  <?php if ($value['status_delete_mv'] == 0) : ?>
                                    ...
                                    <tr class="tr_row">
                                      ...
                                      <td>
                                        <textarea name="reject_client_remarks[<?= $key ?>]" class="form-control input_width"><?= $remarks ?></textarea>
                                      </td>
                                    </tr>
                                  <?php endif; ?>
                                <?php endforeach; ?>
                          ...
                          <div class="row">
                            <div class="col-md-5 text-left">
                              <div class="float-left">
                                ...
                                <!-- <a href="<?= site_url('itr/client_rfi') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a> -->

                                <a href="<?= site_url('itr/itr_pdf/report/' . $report_enc . '/' . $report_rev_enc . '/' . $project_id_enc . '/' . $discipline_enc . '/' . $type_of_module_enc . '/' . $module_enc) ?>" class="btn btn-danger"><i class="fas fa-file-pdf"></i> Report</a>
                              </div>
                            </div>
                                  ...
                                  <?php if ($total_pending > 0) : ?>
                                    <?php if ($user_cookie[7] == 8 or $user_cookie[7] == 1) { ?>
                                      ...
                                      <?php else : ?>
                                        ...
                                        <button onclick="sweetalert('confirm', '<strong>Approve</strong>', this, event); setValue(7)" type="submit" class="btn btn-success" name="status_inspection" value="7"><i class="fas fa-check"></i> Accept</button>
                                        <button onclick="sweetalert('confirm', '<strong>Reject</strong>', this, event); setValue(6)" type="submit" class="btn btn-danger" name="status_inspection" value="6"><i class="fas fa-times"></i> Reject</button>
                                        <button onclick="sweetalert('confirm', '<strong>Accept & Release With Comment</strong>', this, event); setValue(9)" type="submit" class="btn btn-primary" name="status_inspection" value="9"><i class="fas fa-sync"></i> Accept & Release With Comment</button>
                                        <button onclick="sweetalert('confirm', '<strong>Postpone</strong>', this, event); setValue(10)" type="submit" class="btn btn-secondary" name="status_inspection" value="10"><i class="fas fa-sync"></i> Postpone</button>
                                        <button onclick="sweetalert('confirm', '<strong>Re-Offer</strong>', this, event); setValue(11)" type="submit" class="btn btn-warning" name="status_inspection" value="11"><i class="fas fa-sync"></i> Re-Offer</button>
                                        <script type="text/javascript">
                                          function setValue(anu) {
                                            console.log(anu)
                                            $(".approve_input").val(anu)
                                          }
                                        </script>
                    ...
                    <div class="tab-pane fade" id="red_line" role="tabpanel" aria-labelledby="red_line-tab">
                      <div class="row mt-3">
                        <div class="col-md-12">
                          <button class="btn btn-info" onclick="add_attachment_redline_modal(this, <?= $main_data['id_itr'] ?>)" type="button"><i class="fas fa-plus-circle"></i> Add Red-Line</button>
                        </div>
                    ...
                    <div class="tab-pane fade" id="ndt" role="tabpanel" aria-labelledby="ndt-tab">
                      <div class="row mt-3">
                        <div class="col-md-12">
                          <button class="btn btn-info" onclick="add_attachment_nde_modal(this, <?= $main_data['id_itr'] ?>)" type="button"><i class="fas fa-plus-circle"></i> Add NDT</button>
                        </div>
                        <div class="col-md-12 mt-2">
                          <div class="table-responsive overflow-auto">
...
<script>
  ...
  function add_attachment_nde_modal(btn, id_itr) {

    let url = "<?= site_url('itr/add_attachment_nde/') ?>" + id_itr
