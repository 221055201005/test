                           ...
                           ?>
                               <tr>
                                   ...
                                   <td> 
                                     ...
                                     <select  name='paint_system[<?= $value["wp_detail_id"] ?>][]' class='form-control select2_multiple_paint_system' multiple required>
               ...
               <?php //test_var($show_data_activity_paint_system[$vlp]); ?>
                       ...
                       <table class="table table-hover text-center dataTable">
                           ...
                           <?php $no=0; foreach($show_data_irn_list as $key => $value){ ?>    
                            ...
                            <?php if(isset($validation_id_template[$id_workpack][$vlp][$value["id_template"]])){ ?>
