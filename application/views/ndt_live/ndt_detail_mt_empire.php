                          ...
                          <div id='example1'>
                            ...
                            <table border="1px" style="border-collapse: collapse !important;padding:20px !important;" width="100%">
                              ...
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['report_no'] ?>" <?= $is_readonly ?> name="report_no" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Page No</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['page_no'] ?>" <?= $is_readonly ?> name="page_no" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  ...
                                  ?>
                                  <?= $rfi_prefix . '-MT-' . str_pad($main['rfi_no'], 6, 0, STR_PAD_LEFT) ?></td>
                              </tr>
                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Project Name</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><?= $project_list[$main['id_project']]['project_ref'] ?></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Date of Inspection</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="date" class="form-control" value="<?= DATE("Y-m-d", strtotime($main['date_of_inspection'])) ?>" <?= $is_readonly ?> name="date_of_inspection" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['testing_location'] ?>" <?= $is_readonly ?> name="testing_location" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Procedure No.</td>
                                <td colspan="6" style="padding-bottom: 4px; "><?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['mt']['procedure'] ?> Rev. <?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['mt']['procedure_rev'] ?></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">PWHT</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['pwht'] ?>" <?= $is_readonly ?> name="pwht" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                ...
                                ?>
                                <td colspan="6" style="padding-bottom: 4px; ">
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['job_no'] ?>" <?= $is_readonly ?> name="job_no" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Job Description</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['job_desc'] ?>" <?= $is_readonly ?> name="job_desc" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Area of Coverage</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['item_tested'] ?>" <?= $is_readonly ?> name="item_tested" style="width: 90% !important"></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td colspan="6" rowspan="1" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['brand'] ?>" <?= $is_readonly ?> name="brand" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Light Intensity</td>
                                <td colspan="3" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['viewing_condition'] ?>" <?= $is_readonly ?> name="viewing_condition" style="width: 90% !important"></td>

                                <td colspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Examination Stage</td>
                                <td colspan="2" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['examination_stage'] ?>" <?= $is_readonly ?> name="examination_stage" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="1" rowspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Model</td>
                                <td colspan="6" rowspan="1" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['model'] ?>" <?= $is_readonly ?> name="model" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Surface Condition</td>
                                <td colspan="3" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['surface_condition'] ?>" <?= $is_readonly ?> name="surface_condition" style="width: 90% !important"></td>

                                <td colspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Lifting Capacity</td>
                                <td colspan="2" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['lifting_capacity'] ?>" <?= $is_readonly ?> name="lifting_capacity" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="1" rowspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Serial No</td>
                                <td colspan="6" rowspan="1" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['serial_no'] ?>" <?= $is_readonly ?> name="serial_no" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Surface Temperature</td>
                                <td colspan="3" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['surface_temperature'] ?>" <?= $is_readonly ?> name="surface_temperature" style="width: 90% !important"></td>

                                <td colspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Direction of Field</td>
                                <td colspan="2" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['direction_of_field'] ?>" <?= $is_readonly ?> name="direction_of_field" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="1" rowspan="1" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Sensitivity</td>
                                <td colspan="6" rowspan="1" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['sensivity'] ?>" <?= $is_readonly ?> name="sensivity" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Applying Current</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  Continuous <input type="radio" <?= $main['applying_current'] == 1 ? 'checked' : '' ?> <?= $is_readonly ?> name="applying_current" value="1">
                                  Residual <input type="radio" <?= $main['applying_current'] == 2 ? 'checked' : '' ?> <?= $is_readonly ?> name="applying_current" value="2">
                                </td>
                              </tr>

                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Grade Material</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['grade_material'] ?>" <?= $is_readonly ?> name="grade_material" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Magnetic Current</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  AC <input type="radio" <?= $main['magnetic_current'] == 1 ? 'checked' : '' ?> <?= $is_readonly ?> name="magnetic_current" value="1">
                                  DC <input type="radio" <?= $main['magnetic_current'] == 2 ? 'checked' : '' ?> <?= $is_readonly ?> name="magnetic_current" value="2">
                                </td>
                              </tr>
                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Testing Personnel</td>
                                <td colspan="6">
                                  <!-- <select class="form-control select2" onchange="get_personel(this)" name="testing_personel" <?= $main['status_return'] > 0  ? "readonly" : ""; ?>>
                                    <option value="">---</option>
                                    <?php foreach ($testing_personnel as $key => $value) : ?>
                                      <option value="<?= $value['id'] ?>" <?= $value['id'] == $main['testing_personel'] ? 'selected' : '' ?>>
                                        <?= $value['personel_name'] ?>
                                      </option>
                                    <?php endforeach; ?>
                                  </select> -->
                                  <input type="text" class="form-control autocomplete_testing_personel" name="testing_personel" value="<?= $main['testing_personel'] ?>" <?= $is_readonly ?> name="background" style="width: 90% !important">
                                </td>
                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Consumable Brand</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['consumable_brand'] ?>" <?= $is_readonly ?> name="consumable_brand" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Certificate No.</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control certificate" value="<?= $main['certificate_no'] ?>" <?= $is_readonly ?> name="certificate_no" style="width: 90% !important"></td>

                                <td colspan="2" style="font-weight: bold; text-align:left; padding-bottom: 4px; ">Batch Number</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['batch_number'] ?>" <?= $is_readonly ?> name="batch_number" style="width: 90% !important"></td>
                              </tr>
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; "><input type="text" class="form-control" value="<?= $main['medium'] ?>" <?= $is_readonly ?> name="medium" style="width: 90% !important"></td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td colspan="6" rowspan="1">
                                  <input type="text" class="form-control" value="<?= $main['background'] ?>" <?= $is_readonly ?> name="background" style="width: 90% !important">
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  YES <input type="radio" <?= $main['demagnetization'] == 1 ? 'checked' : '' ?> <?= $is_readonly ?> name="demagnetization" value="1">
                                  NO <input type="radio" <?= $main['demagnetization'] == 2 ? 'checked' : '' ?> <?= $is_readonly ?> name="demagnetization" value="2">
                                </td>
                              </tr>

                              <tr>
                                <td colspan="2">Applicable Particle</td>
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  YES <input type="radio" <?= $main['applicable_particle'] == 1 ? 'checked' : '' ?> <?= $is_readonly ?> name="applicable_particle" value="1">
                                  NO <input type="radio" <?= $main['applicable_particle'] == 2 ? 'checked' : '' ?> <?= $is_readonly ?> name="applicable_particle" value="2">
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td colspan="6" style="text-align:center; padding-bottom: 4px; ">
                                  <input type="date" class="form-control" <?= $is_readonly ?> name="yoke_expired_calibration_date" style="width: 100%" value="<?= DATE('Y-m-d', strtotime($main['yoke_expired_calibration_date'])) ?>">
                                </td>
                              </tr>
                                ...
                                <tr style="text-align: center; vertical-align: middle;">
                                  <td>
                                    ...
                                    <?php if ($user_permission[217] == 1) { ?>
                                      <button type="button" data-id="<?= $main['id_mt'] ?>" data-uniq_id_report="<?= $main['uniq_id_report'] ?>" data-id_joint="<?= $value['id_joint'] ?>" data-ndt_type="2" onclick="sweetalert('confirm', 'Are you sure to <b class=&#34;text-danger&#34;>&nbsp;Return&nbsp;</b> this Joint?', this, event, 'return_joint')" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> </button>
                                    <?php } ?>
                                    <input type="hidden" <?= $is_readonly ?> name="id_joint[<?= $value['id_mt'] ?>]" value="<?= $value['id_joint'] ?>">

                                  </td>
                                  <td>
                                    <?= $joint[$value['id_joint']]['drawing_wm'] . ' Rev.' . $joint[$value['id_joint']]['rev_wm'] ?><br>
                                  ...
                                  <td><input class="form-control" type="text" required <?= $is_readonly ?> name="tested_length[<?= $value['id_mt'] ?>]" value=<?= $value['tested_length'] ?>></td>
                                  ...
                                  <td style="vertical-align: middle;">
                                    <table>
                                      <tr>
                                        <td>ACC</td>
                                        <td><input type="radio" <?= $value['result'] == 1 ? 'checked' : '' ?> <?= $is_readonly ?> name="result[<?= $value['id_mt'] ?>]" value="1"></td>
                                      </tr>
                                      <tr>
                                        <td>REJ</td>
                                        <td><input type="radio" <?= $value['result'] == 2 ? 'checked' : '' ?> <?= $is_readonly ?> name="result[<?= $value['id_mt'] ?>]" value="2"></td>
                                      </tr>
                                    </table>
                                  ...
                                  <td>
                                    ...
                                    ?>
                                    <input class="form-control rej_row_<?= $value["id_mt"] ?>" type="number" <?= $is_readonly ?> name="deffect_length[<?= $value['id_mt'] ?>]" value=<?= $value['deffect_length'] ?>>
                                    <?php // } 
                                    ?>
                                  </td>
                                  <td>
                                    <?php // if($value['result']==2){ 
                                    ?>
                                    <select class="select2 rej_row_<?= $value["id_mt"] ?>" <?= $is_readonly ?> name="deffect_type[<?= $value['id_mt'] ?>]">
                                      <option value="">---</option>
                                  ...
                                  <td>
                                    <?php //if($value['result']==2){ 
                                    ?>
                                    <input class="form-control rej_row_<?= $value["id_mt"] ?>" type="number" <?= $is_readonly ?> name="datum[<?= $value['id_mt'] ?>]" value=<?= $value['datum'] ?>>
                                    <?php //} 
                                    ?>
                                  </td>

                                  <td>
                                    <!-- <textarea rows="1" <?= $is_readonly ?> name="inspection_cat[<?= $value['id_mt'] ?>]"><?= $value['inspection_cat'] ?></textarea> -->
                                    <input class="form-control" type="text" <?= $is_readonly ?> name="inspection_cat[<?= $value['id_mt'] ?>]" value=<?= $value['inspection_cat'] ?>>
                                  </td>
                                  <td>
                                    <input class="form-control" type="text" <?= $is_readonly ?> name="remarks[<?= $value['id_mt'] ?>]" value=<?= $value['remarks'] ?>>
                                    <!-- <textarea rows="1" <?= $is_readonly ?> name="remarks[<?= $value['id_mt'] ?>]"><?= $value['remarks'] ?></textarea> -->
                                  </td>
                                </tr>
                              <?php
                              ...
                              <tr>
                                <td colspan="17">
                                  Note:
                                  <textarea class="form-control" <?= $is_readonly ?> name="remarks_vendor"><?= $main["remarks_vendor"] ?></textarea>
                                </td>
                              </tr>
                                ...
                                <tr>
                                  ...
                                  <td colspan="5" style="text-align:center ;border-left: 0px; border-right: 0px">
                                    ...
                                    <?php if ($main['status_inspection'] == 5) { ?>
                                      ...
                                      <button type="button" onclick="return_data(this, 6, 'mt')" class="btn btn-danger">
                              ...
                              <?php if ($main['status_inspection'] == 6) { ?>
                                  <tr style="border-top: 1px  solid #777 !important;">
                                    <td colspan="2" style="border: none !important; font-weight: bold; color: red;">Client Returned By</td>
                                    <td colspan="6" style="border: none !important;">: <?= @$user[$main['returned_client_by']]['full_name']?></td>
                                    <td colspan="9" style="border: none !important;"></td>
                                  </tr>
                                  <tr style="border: none !important;">
                                    <td colspan="2" style="border: none !important; font-weight: bold; color: red;">Client Returned Date</td>
                                    <td colspan="6" style="border: none !important;">: <?= date("d F Y H:i", strtotime($main['returned_client_date'])) ?></td>
                                    <td colspan="9" style="border: none !important;"></td>
                                  </tr>
                                  <tr style="border: none !important;">
                                    <td colspan="2" style="border: none !important; font-weight: bold; color: red;">Client Returned Remarks</td>
                                    <td colspan="6" style="border: none !important;">: <?= $main['client_reject_remarks'] ?></td>
                                    <td colspan="9" style="border: none !important;"></td>
                                  </tr>
                                <?php } ?>
                            </table>
                            ...
                            <?php if ($main['status_inspection'] == 6 && $this->user_cookie[7] != 8) { ?>
                              <button type="button" onclick="retransmit_to_client(this, 5, 'mt')" class="btn btn-primary"><i class="fa fa-arrow-right"></i></i></i> Transmit to Client</button>
                            <?php } ?>
                            <?php if (
                              $main["tested_by"]
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea <?= $is_readonly ?> name='remarks' class='form-control' required="" style="height: 100px !important"></textarea>
...
<script>
  ...
  function get_personel(data_personel) {
    let id_personnel = data_personel.value
    if (typeof certificate_list[id_personnel] !== "undefined") {
      $('.certificate').val(certificate_list[id_personnel])
    }
  }
</script>
...
<script>
  $('.autocomplete_testing_personel').autocomplete({
    source: function(request, response) {
      $.ajax({
        url: "<?php echo base_url() ?>ndt_live/autocomplete_testing_personel",
        data: {
          term: request.term
        },
        dataType: 'json',
    ...
    select: function(event, ui) {
      ...
      if (label == 'No Data.') {
        ...
        $.ajax({
          url: "<?php echo base_url() ?>ndt_live/get_testing_personel",
          dataType: "json",
          data: {
            personel_id: id
          },
          success: function(result) {
            $(certificate).val(result.certificate_number);
          }
        });
      }
    }
