...
// if ($main['status_inspection'] >= 5) {
// 	$is_disabled = "disabled";
// }
if ($main['qc_subcont_by'] && $main['qc_by'] && $main['client_by']) {
	$is_disabled = "disabled";
}
$is_signable = true;
								...
								<form action="<?= site_url('ndt_live/ndt_rt_update_process') ?>" method="post">
														...
														<td class="col-table-inner border-bottom">
															<table>
																...
																<tr>
																	...
																	<td class="col-title col-nowrap">:</td>
																	<td><textarea rows="3" name="job_desc" class="<?= $input_class ?>" <?= $is_disabled ?>><?= $main['job_desc'] == '' ? $title_drawing : $main['job_desc'] ?></textarea></td>
																</tr>
															</table>
														</td>
														<td class="col-table-inner border-bottom">
															<table>
																...
																<tr>
																	...
																	<td class="col-title col-nowrap">:</td>
																	<td>
																		<?= $report_form[$main['id_project']][$company_id][$main['discipline']][$main['module']][$main['type_of_module']] . '-RT-' . str_pad($main['rfi_no'], 6, 0, STR_PAD_LEFT) ?>
																	</td>
																</tr>
																<tr>
															...
															<tr class="<?= 'joint' . $value['id_joint'] ?>">
																...
																<td>
																	...
																	<?php if ($is_first_joint) : ?>
																		<button type="button" class="btn btn-sm btn-flat btn-block btn-success btn-add-row mt-1" onclick="add_row(this, '<?= $value['id_joint'] ?>')" title="Add Row"><i class="fas fa-plus"></i></button>
																	<?php else : ?>
																		<button type="button" class="btn btn-sm btn-flat btn-block btn-danger btn-delete-row mt-1" onclick="delete_row_db(this, <?= @$film['id'] ?>)" title="Delete Row"><i class="fas fa-trash"></i></button>
																	<?php endif; ?>
																</td>
																<td>
																...
																<td><input type="text" name="rt_item_density_iqi[<?= $no ?>]" class="<?= $input_class ?>" value="<?= $film['density_iqi'] ?>" <?= $is_disabled ?>></td>
									...
									<div class="row">
										<div class="col-md-12 text-center p-2">
											<?php if ($main['status_inspection'] == 0 || $is_disabled == '') : ?>
