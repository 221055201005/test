...
<body>
  ...
  <header>
    ...
    <table border="1px" style="border-collapse: collapse !important; padding-right: 3px !important; margin-top: 37px;" width="100%">
      <tr>
        <td colspan="17">
          <table style="width:100%">
            <tr>
              ...
              <td width="23%" class="text-right valign-middle">
                <img src="<?= $project['client_logo'] ?>" style='width: 2.5cm;' />
              </td>
            </tr>
          </table>
        </td>
      ...
      <tr>
        ...
        <td colspan="6" style="text-align:left; padding-bottom: 4px; "></td>
      </tr>
      <tr>
        <td colspan="3" style="font-weight: bold; text-align:left; padding-bottom: 4px; width: 150px !important;">Company</td>
      ...
      <tr>
        ...
        <td colspan="6" style="text-align:left; padding-bottom: 4px; "><?= $project_list[$main['id_project']]['project_ref'] ?></td>
      ...
      <tr>
        ...
        ?>
        <td colspan="6" style="text-align: left; padding-bottom: 4px; ">
          <?= $master_joint[0]['drawing_no'] . ' Rev. ' . $master_joint[0]['transmit_gaas_rev'] ?>
        </td>
      ...
      <tr>
        <td colspan="2" style="text-align: left; font-weight: bold">Applicable Particle</td>
  ...
  <table border="1px" style="border-collapse: collapse !important; margin-top: -5px;" width="100%">
    <thead>
      <tr>
        <td rowspan="2" style="text-align:center; vertical-align: middle; width: 15px !important;">S/N</td>
        <td rowspan="2" style="text-align:center; vertical-align: middle; width: 100px !important;">Weld Map Dwg / Line & Spool No</td>
    ...
    <tbody>
      ...
      ?>
        <tr style="text-align: center; vertical-align: middle;">
          <td><?= $no++ ?></td>
          <td><strong style="font-weight: normal; <?= $value['id_joint'] == $detail[($key - 1)]['id_joint'] ? 'color: white' : '' ?>"><?= $joint[$value['id_joint']]['drawing_wm'] . ' Rev.' . $joint[$value['id_joint']]['rev_wm'] ?></td>
  ...
  <table border="1px" width="100%" style="margin-top: -1px !important; border-top: none;">
    ...
    <tr>
      <td width="25%" style="vertical-align: top !important;">
        ...
        <?php if ($main['tested_by']) : ?>
          <center>
            <img src="data:image/png;base64,<?= $user[$main['tested_by']]['sign_approval'] ?>" style='width: 2.5cm; height: 2cm' />
          </center>
        <?php else : ?>
      ...
      <?php if ($joint[$main["id_joint"]]["company_id"] == 5) { ?>
        <td width="25%" style="vertical-align: top !important;">
          ...
          <?php if ($main['qc_subcont_by']) : ?>
            <center>
              <img src="data:image/png;base64,<?= $user[$main['qc_subcont_by']]['sign_approval'] ?>" style='width: 2.5cm; height: 2cm' />
            </center>
          <?php else : ?>
            <div style='height:1.98cm;'>
      ...
      <td width="25%" style="vertical-align: top !important;">
        ...
        <?php if ($main['qc_by']) : ?>
          <center>
            <img src="data:image/png;base64,<?= $user[$main['qc_by']]['sign_approval'] ?>" style='width: 2.5cm; height: 2cm' />
          </center>
        <?php else : ?>
          <div style='height:1.98cm;'>
        ...
        <center>
          <div style="page-break-inside: avoid;">
            <?php if ($main['client_by']) { ?>
              <img src="data:image/png;base64,<?= $user[$main['client_by']]['sign_approval'] ?>" style='width: 2.5cm; height: 2cm'' />
                    <?php } else { ?>
                      <div style=' height:1.98cm;'>
          </div>
        <?php } ?>
