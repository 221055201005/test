...
<body>
	<div id="report_rt">
		<div id="report_rt_content">
			...
			<!-- MAIN INFORMATION -->
			<table id="id_tbl_main_information">
				<tbody>
					<tr>
					...
					<tr>
						...
						<td class="col-title col-nowrap">:</td>
						<td><?= date('Y-m-d', strtotime($main['date_of_rfi'])) ?></td>
					</tr>
					<tr>
						<td class="col-title col-nowrap">GA/ASSY/ISOMETRIC Drawing No.</td>
						<td class="col-title col-nowrap">:</td>
						<td><?= $main['drawing_no'] ?> Rev.<?= $main['drawing_rev'] ?></td>
					...
					<tr>
						...
						<td rowspan="4" class="no-bb"><?= $main['job_desc'] ?></td>
					...
					<tr>
							...
							<table>
								...
								<tr>
									...
									<td class="col-table-inner">
										<table>
											<tr>
												<td class="col-nowrap"><?= $main['weld_thk'] ?></td>
												<td class="col-nowrap">
													<label>
						...
						<td class="col-table-inner text-top" style="width: 35%;">
							...
							<table>
								...
								<tr>
									<td class="col-nowrap"><b>Geometric Unsharpness</b> : <?= $main['geometric_unsharpness'] ?> : <?= $main['geometric_unsharpness'] ?></td>
								</tr>
								<tr>
							...
							<table>
								...
								<tr>
									<td class="col-nowrap"><b>Block Thickness</b> : <?= $main['block_thickness'] ?> mm
									</td>
								</tr>
							</table>
							<table>
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td><?= $value['inspection_category'] ?></td>
							...
							<?php } else { ?>
								...
								<td>-</td>
							<?php } ?>
							<td><?= $value['density_iqi'] ?></td>
							<td><?= $value['density_iqi_max'] ?></td>
							<td><?= $value['density_iqi_min'] ?></td>
							<td><?= $value['sensitivity'] ?></td>
							<td><?= $value['discontinuities_type'] ?></td>
							<td><?= $value['remarks'] ?></td>
						</tr>
					<?php endforeach; ?>
				</tbody>
						...
						<td class="col-table-inner">
							...
							<table>
								<tr class="font-weight-bold">
									...
									<td style="width: 25%">QC Inspector</td>
