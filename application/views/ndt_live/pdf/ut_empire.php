...
<header>
  <table border="1" width="100%" cellpadding="2">
    ...
    <tr>
      ...
      <td colspan="1"><?= $main['date_of_inspection'] ? date('Y-m-d', strtotime($main['date_of_inspection']))  : '' ?></td>

      <td class="col_title" colspan="1" style="height: 29px;">Examination Stage</td>
      <td colspan="4">
    ...
    <tr>
      <td class="col_title" colspan="2">COMPANY</td>
    ...
    <tr>
      ...
      <td colspan="7"><?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['ut']['procedure'] ?> Rev. <?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['ut']['procedure_rev'] ?></td>
    ...
    <tr>
      ...
      <td colspan="6"><?= $personel[$main['testing_personnel']]['personel_name'] ?></td>
    </tr>
...
<body>
  ...
  <table border="1" cellpadding="2" style="width: 100%; margin-top: -2px;">
    ...
    foreach ($list as $key => $value) : ?>
      ...
      <tr class="text-center">
        <td><?= $no++ ?></td>
        <td><?= $joint[$value['id_joint']]['drawing_wm'] . ' Rev.' . $joint[$value['id_joint']]['rev_wm'] ?></td>
        ...
        <td><?= nl2br($value['defect_length_new']) ?></td>
        <td><?= nl2br($value['defect_depth']) ?></td>
        <td>
          <?php
          $deftype = [];
      ...
      <tr>
        ...
        <td width="25%" style="vertical-align: top !important;">
          ...
          <?php if ($main['qc_subcont_by']) : ?>
            <center>
              <img src="data:image/png;base64,<?= $user[$main['qc_subcont_by']]['sign_approval'] ?>" style='width: 3cm; height: 2cm;' />
            </center>
          <?php else : ?>
            <div style='height:1.98cm;'>
          ...
          <br>
          <strong>Date &nbsp;&nbsp;: </strong> <?= $main['date_qc_subcont_by'] ? date('d-M-Y', strtotime($main['date_qc_subcont_by'])) : "" ?>
        </td>
        <td width="25%" style="vertical-align: top !important;">
          Reviewed By :
          <br>
        ...
        <td width="25%" style="vertical-align: top !important;">
          ...
          <?php if ($main['third_party_approval_by']) : ?>
            <div style='height:3cm;'>
              <img src="data:image/png;base64,<?= $user[$main['third_party_approval_by']]['sign_approval'] ?>" style='width: 3cm; height: 2cm;' />
            </div>
          <?php else : ?>
              <div style='height:1.98cm;'>
              </div>
