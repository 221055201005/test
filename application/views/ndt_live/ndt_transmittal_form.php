                ...
                <tbody>
                  ...
                  <tr <?= $submitted=='submitted' ? (strtotime(DATE('Y-m-d H:i:s'))-strtotime($value['ndt_transmittal_datetime'])>43200 ? 'class=""' : '') : '' ?> >
                    ...
                    <td class="align-middle">
                      <b>
                      <?php 
                          if($ndt_submit[2][$value['id_joint']] && $ndt_submit[2][$value['id_joint']]['status_inspection'] != 12){
                    ...
                    <td class="align-middle">
                      <b>
                      <?php 
                          if($ndt_submit[3][$value['id_joint']] && $ndt_submit[3][$value['id_joint']]['status_inspection'] != 12){
                            echo '<i class="fas fa-check"></i>';
                          } else {
                            echo "-";
                          }
                    ...
                    <td class="align-middle">
                      <b>
                      <?php 
                          if($ndt_submit[1][$value['id_joint']] && $ndt_submit[1][$value['id_joint']]['status_inspection'] != 12){
                            echo '<i class="fas fa-check"></i>';
                          } else {
                            echo "-";
                          }
                    ...
                    <td class="align-middle">
                      <b>
                      <?php 
                          if($ndt_submit[7][$value['id_joint']] && $ndt_submit[7][$value['id_joint']]['status_inspection'] != 12){
                            echo '<i class="fas fa-check"></i>';
                          } else {
                            echo "-";
                          }
