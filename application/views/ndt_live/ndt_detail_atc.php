                        ...
                        <div id='example1'>
                            ...
                            <?php foreach ($detail as $key => $value) { ?>
                              ...
                              <tr style="text-align: center; vertical-align: middle;">
                                ...
                                <td style="vertical-align: middle;">
                                  ACC <input <?= $main["status_inspection"]>=1 ? 'disabled' : '' ?> type="radio" <?= $value['result']==1 ? 'checked' : '' ?> name="result[<?= $value['id_atc'] ?>]" value="1">
                                  <br>
                                  REJ <input <?= $main["status_inspection"]>=1 ? 'disabled' : '' ?> type="radio" <?= $value['result']==2 ? 'checked' : '' ?> name="result[<?= $value['id_atc'] ?>]" value="2">   
                                </td>  

                                <td>
                                  <input class="form-control" <?= $main["status_inspection"]>=1 ? 'readonly' : '' ?> type="text" name="remarks[<?= $value['id_atc'] ?>]" value=<?= $value['remarks'] ?>>
                                </td>
                              </tr>
                            <?php } ?>
                          ...
                          <br/>
                            ...
                            <?php if ($user_permission[208] == 1 && $main['status_inspection'] != 12) { ?>
                              <button type="button" data-id="<?= $main['id'] ?>" onclick="sweetalert('confirm', 'Are you sure to <b class=&#34;text-danger&#34;>&nbsp;Void&nbsp;</b> this?', this, event, 'void_row_db')" class="btn btn-danger btn-sm"><i class="fa fa-exclamation-triangle"></i> Void</button>
                            <?php } ?>
                          <br/>
                        </div>
                      </form>
...
<script>
	function void_row_db(btn) {
		...
		$.ajax({
			url: "<?php echo base_url() ?>ndt_live/delete_void_atc",
			data: {
				id: id,
			},
			type: 'post',
