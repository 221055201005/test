                        ...
                        <td colspan="17" class="text-center">
                          <img style="width:100%" src="<?= base_url() ?>img/header_report_2.png">
                              ...
                              <tr>
                                ...
                                <td colspan="7"><?= $project[$main['id_project']]['project_ref'] ?></td>
                                ...
                                <td colspan="2" class="text-nowrap">
                                  ...
                                  <?= $rfi_prefix . '-UT-' . str_pad($main['rfi_no'], 6, 0, STR_PAD_LEFT) ?></td>

                                <td class="col_title" colspan="2">Date Of RFI</td>
                                <td colspan="2">
                                  <?= $main['rfi_submitted_date'] ? date('Y-m-d', strtotime($main['rfi_submitted_date'])) : '' ?>
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td colspan="7">
                                  ...
                                  <!-- <ul style="list-style-position: inside; padding-left: 0;">
                                    <li>DNVGL-CG-0051 / BS EN ISO 17640 </li>
                                    <li>ISO 11666 ACCEPTANCE LEVEL 2</li>
                                    <li>EN ISO 5817 Level B"</li>
                                  </ul> -->
                                </td>
                              ...
                              <tr>
                                ...
                                <td colspan="7">
                                  <?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['ut']['procedure'] ?> Rev. <?= $acceptance_criteria_form[$main['id_project']][$joint[$main['id_joint']]['company_id']][$main['discipline']][$main['module']][$main['type_of_module']][$joint[$main['id_joint']]['class']]['ndt']['ut']['procedure_rev'] ?>
                                  <!-- <input type="text" name="procedure_no" class="<?= $input_class ?>" value="<?= $main['procedure_no'] ?>" <?= $is_disabled ?>> -->
                                </td>
                                <td class="col_title" colspan="2">Area of Coverage</td>
                                <td colspan="6">
                              ...
                              <tr>
                                ...
                                <td colspan="7">
                                  <?= $main['drawing_no'] ?> Rev. <?= $main['drawing_rev_no'] ?> <br>
                                  <?php if (isset($main['drawing_no'])) { ?>
                                    <?php
                              ...
                              <tr>
                                ...
                                <td colspan="6">
                                  <select class="form-control select2" onchange="get_personel(this)" name="testing_personnel" <?= $main['status_return'] > 0  ? "disabled" : ""; ?>>
                                    <option value="">---</option>
                              ...
                              <tr>
                                ...
                                <td colspan="6">
                                  <input type="text" name="certificate_no" class="<?= $input_class ?> certificate" value="<?= $main['certificate_no'] ?>" <?= $is_disabled ?>>
                                </td>
                              </tr>

                              <tr>
                                <td class="col_title" colspan="17">SPECIMEN DATA : </td>
                              </tr>
                              <tr>
                                <td colspan="17">
                                  <table class="table table-borderless table-sm">
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="grade_material" class="<?= $input_class ?>" value="<?= $main['grade_material'] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="delivery_condition" class="<?= $input_class ?>" value="<?= $main['delivery_condition'] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="surface_condition" class="<?= $input_class ?>" value="<?= $main['surface_condition'] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td style="width:1%">:
                                      <td>
                                        <input type="text" name="temperature" class="<?= $input_class ?>" value="<?= $main['temperature'] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    ...
                                    <!-- <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="holding_time" class="<?= $input_class ?>" value="<?= $main['holding_time'] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr> -->
                              ...
                              <?php foreach ($range_probes as $value) : ?>
                                <tr>
                                  ...
                                  <td class="col_title text-center">
                                    <input type="text" name="serial_no_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["serial_no_$value"] ?>" <?= $is_disabled ?>>
                                  </td>
                                  <td class="col_title text-center">
                                    <input type="text" name="type_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["type_$value"] ?>" <?= $is_disabled ?>>
                                  </td>

                                  <td class="col_title text-center">
                                    <input type="text" name="size_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["size_$value"] ?>" <?= $is_disabled ?>>
                                  </td>
                                  <td class="col_title text-center">
                                    <input type="text" name="frequency_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["frequency_$value"] ?>" <?= $is_disabled ?>>
                                  </td>
                                  <td class="col_title text-center" colspan="4">
                                    <input type="text" name="reference_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["reference_$value"] ?>" <?= $is_disabled ?>>
                                  </td>

                                  <td class="col_title text-center">
                                    <input type="text" name="tr_loss_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["tr_loss_$value"] ?>" <?= $is_disabled ?>>
                                  </td>

                                  <td class="col_title text-center" colspan="2">
                                    <input type="text" name="scan_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["scan_$value"] ?>" <?= $is_disabled ?>>
                                  </td>
                                  <td class="col_title text-center" colspan="5">
                                    <input type="text" name="range_fsl_<?= $value ?>" class="<?= $input_class ?>" value="<?= $main["range_fsl_$value"] ?>" <?= $is_disabled ?>>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                                ...
                                <td colspan="17">
                                  <table class="table table-borderless table-sm">
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="couplant" class="<?= $input_class ?>" value="<?= $main["couplant"] ?>" <?= $is_disabled ?>>
                                      </td>

                                      <td class="col_title"> BRAND</td>
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="brand" class="<?= $input_class ?>" value="<?= $main["brand"] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="calibration_block" class="<?= $input_class ?>" value="<?= $main["calibration_block"] ?>" <?= $is_disabled ?>>
                                      </td>
                                      <td class="col_title" style="width:230px"> MODEL</td>
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="model" class="<?= $input_class ?>" value="<?= $main["model"] ?>" <?= $is_disabled ?>>
                                      </td>
                                    </tr>
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="reference_block" class="<?= $input_class ?>" value="<?= $main["reference_block"] ?>" <?= $is_disabled ?>>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="calibration_serial_no" class="<?= $input_class ?>" value="<?= $main["calibration_serial_no"] ?>" <?= $is_disabled ?>>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="calibration_block_thickness" class="<?= $input_class ?>" value="<?= $main["calibration_block_thickness"] ?>" <?= $is_disabled ?>>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="sensitivity" class="<?= $input_class ?>" value="<?= $main["sensitivity"] ?>" <?= $is_disabled ?>>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="evaluation_level" class="<?= $input_class ?>" value="<?= $main["evaluation_level"] ?>" <?= $is_disabled ?>>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="recording_level" class="<?= $input_class ?>" value="<?= $main["recording_level"] ?>" <?= $is_disabled ?>>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:1%">:</td>
                                      <td>
                                        <input type="text" name="scanning_technique" class="<?= $input_class ?>" value="<?= $main["scanning_technique"] ?>" <?= $is_disabled ?>>
                                ...
                                <tr class="text-center">
                                  <td>
                                    ...
                                    <?php if ($user_permission[217] == 1) { ?>
                                      <button type="button" data-id="<?= $main['id_ut'] ?>" data-uniq_id_report="<?= $main['uniq_id_report'] ?>" data-id_joint="<?= $value['id_joint'] ?>" data-ndt_type="3" onclick="sweetalert('confirm', 'Are you sure to <b class=&#34;text-danger&#34;>&nbsp;Return&nbsp;</b> this Joint?', this, event, 'return_joint')" class="btn btn-danger btn-sm"><i class="fa fa-undo"></i> </button>
                                    <?php } ?>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                    <?php if ($allow_update) : ?>
                                      ...
                                      <textarea name="defect_length[<?= $key ?>]" class="<?= $input_class ?>"><?= $value['defect_length_new'] ?></textarea>
                                    <?php else : ?>
                                      <?= nl2br(@$value['defect_length_new']) ?>
                                    <?php endif; ?>
                                  </td>
                                  <td>
                                    <?php if ($allow_update) : ?>
                                      <!-- <input type="text" step="any" value="<?= $value['defect_depth'] ?>" name="defect_depth[<?= $key ?>]" class="<?= $input_class ?>"> -->
                                      <textarea name="defect_depth[<?= $key ?>]" class="<?= $input_class ?>"><?= $value['defect_depth'] ?></textarea>
                                    <?php else : ?>
                                      <?= nl2br(@$value['defect_depth']) ?>
                                    <?php endif; ?>
                                  </td>

                                  <td>
                                    <?php if ($allow_update) : ?>
                                      <!-- <select name="deffect_type[<?= $key ?>]" class="select2 select2-sm" multiple>
                                        <option value="">---</option>
                                      ...
                                      if ($value['defect_type']) {
                                        $arr_defect = explode(';', $value['defect_type']);
                                      }

                                      ?>
                                      <table id="deffect_select_<?= $key ?>">
                                        <?php foreach ($arr_defect as $i => $d) : ?>
                                          <tr>
                                            <td>
                                              <select name="defect_type[<?= $key ?>][]" class="custom-select">
                                                <option value="">---</option>
                                                <?php foreach ($deffect_list as $v) : ?>
                                                  <option value="<?= $v['id'] ?>" <?= $v['id'] == $d ? 'selected' : '' ?>><?= $v['ctq_initial'] ?> - <?= $v['ctq_description'] ?></option>
                                                <?php endforeach; ?>
                                              </select>
                                            </td>
                                            <td>
                                              <?php if ($i == 0) : ?>
                                                <button type="button" onclick="add_row_deffect(this, <?= $key ?>)" class="btn btn-success btn-sm"><i class="fas fa-plus"></i></button>
                                              <?php else : ?>
                                                <button type="button" onclick="delete_row_deffect(this, <?= $key ?>)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                              <?php endif; ?>
                                            </td>
                                          </tr>
                                        <?php endforeach; ?>
                                    ...
                                    <?php else : ?>
                                      <?php
                                      $deftype = [];
                                      foreach (explode(";", $value['defect_type']) as $key_dt => $value_dt) {
                                        $deftype[] = $deffect_list[$value_dt]['ctq_initial'];
                                      }
                                      print_r(implode(", <br>", $deftype));
                                      ?>
                                    <?php endif; ?>
                                    <script>
                                      // $("select").select2();
                                  ...
                                  <td>
                                    ...
                                    <div class="text-justify">
                                      <div class="form-check text-success">
                                        <input <?= $is_disabled  ? "disabled" : ""; ?> class="form-check-input input_radio approve" type="radio" name="result[<?= $key ?>]" value="1" style="width: 17px; height: 17px" <?= $value['result'] == 1 ? 'checked' : '' ?> required>
                                        <label class="form-check-label"><strong>Acc</strong></label>
                                      </div>
                                      <div class="form-check text-danger">
                                        <input <?= $is_disabled  ? "disabled" : ""; ?> class="form-check-input input_radio reject" type="radio" name="result[<?= $key ?>]" value="2" style="width: 17px; height: 17px" <?= $value['result'] == 2 ? 'checked' : '' ?> required>
                              ...
                              <tr>
                                <td colspan="17">
                                  Note :
                                  <br>
                                  <textarea name="note" style="height:100% !important;" class="<?= $input_class ?>" <?= $main['status_inspection'] > 13 ? "readonly" : ""; ?>><?= $main['note'] ?></textarea>
                                </td>
                              </tr>
                              <tr>
                                <td colspan="17">
                            ...
                            <table border="2" style="margin-top: -2px; width:100%;">
                              <?php if ($visual_list[$joint[$main["id_joint"]]["id_joint"]]["company_id"] == 5) { ?>
                                ...
                                <tr>
                                  ...
                                  <td width="25%">
                                    <table class="table table-borderless table-sm" style="font-size: 11px">
                                      ...
                                      <tr>
                                        <td colspan="3">NDT/QC Inspector(DSAW)</td>
                                      </tr>
                                      <tr>
                                        <td colspan="3" class="text-center">
                                      ...
                                      <tr>
                                        <td class="col_title">Name</td>
                                        <td style="width:1%">:</td>
                                        <td><?= $main['qc_subcont_by'] ? $user[$main['qc_subcont_by']]['full_name'] : "" ?></td>
                                      </tr>
                                      <tr>
                                        <td class="col_title">Date</td>
                                        <td style="width:1%">:</td>
                                        <td><?= $main['date_qc_subcont_by'] ? date('d-M-Y', strtotime($main['date_qc_subcont_by'])) : "" ?></td>
                                      </tr>
                                    </table>
                                  ...
                                  <td width="25%">
                                    <table class="table table-borderless table-sm" style="font-size: 11px">
                                      ...
                                      <tr>
                                        <td colspan="3">NDT/QC Inspector</td>
                                      </tr>
                                      <tr>
                                        <td colspan="3" class="text-center">
                                          <?php if ($main['qc_by']) : ?>
                                          ...
                                          <?php else : ?>
                                            <div style='height:3cm;'>
                                              ...
                                              <?php if ($main['status_inspection'] == 4) : ?>
                                                ...
                                                <button type="button" onclick="return_data(this, 6, 'ut')" class="btn btn-outline-danger"><i class="fas fa-undo"></i>  Return Client</button>
                                              <?php endif; ?>
                                            </div>
                                          <?php endif; ?>
                                      ...
                                      <tr>
                                        <td colspan="3" class="text-center">
                                          ...
                                          <?php else : ?>
                                            <div style='height:3cm;'>
                                              <br>
                                              <?php if ($main['status_inspection'] == 4 && ($this->user_cookie[7] == 8 || $user_permission[0] == 1)) : ?>
                                                <button type="button" onclick="approval_data(this, 7, 'client')" class="btn btn-outline-success"><i class="fas fa-signature"></i> Digital Sign</button>
                                                <button type="button" onclick="return_data(this, 6, 'ut')" class="btn btn-outline-danger"><i class="fas fa-undo"></i>  Return Client</button>
                                              <?php endif; ?>
                                            </div>
                      ...
                      <div class="row">
                        <div class="col-md-12 text-center p-2">
                          ...
                          <?php if ($main['status_inspection'] == 6 && $this->user_cookie[7] != 8) { ?>
                            <button type="button" onclick="retransmit_to_client(this, 4, 'ut')" class="btn btn-primary"><i class="fa fa-arrow-right"></i></i></i> Transmit to Client</button>
                          <?php } ?>
                        </div>
                      </div>
                    </form>
...
<script>
  ...
  function add_row_deffect(select, key) {
    let row = `
    <tr>
      <td>
        <select name="defect_type[${key}][]" class="custom-select" required>
          <option value="">---</option>
          <?php foreach ($deffect_list as $v) : ?>
            <option value="<?= $v['id'] ?>"><?= $v['ctq_initial'] ?> - <?= $v['ctq_description'] ?></option>
          <?php endforeach; ?>
        </select>
      </td>
      <td>
        <button type="button" onclick="delete_row_deffect(this, ${key})" class="btn btn-danger btn-sm"><i class="fas fa-minus"></i></button>
      </td>
    </tr>
    `

    $(`#deffect_select_${key}`).append(row)
  }

  function delete_row_deffect(select) {
...
<script>
  function void_row_db(btn) {
    ...
    $.ajax({
      url: "<?php echo base_url() ?>ndt_live/delete_void_ut_empire",
      data: {
...
<script>
  ...
  function get_personel(data_personel) {
    ...
    if (typeof certificate_list[id_personnel]) {
