            ...
            <div class="col-md-12">
              ...
              <div class="tab-content">
                    ...
                    <div class="col-md-12">
                      ...
                      <form action="<?= base_url("ndt_live/update_ndt_pwht") ?>" method="POST">
                        ...
                        <div class="row">
                          ...
                          <div class="col-2">
                            <input class="form-control" type="date" name="date_of_inspection"
                              value="<?= DATE('Y-m-d', strtotime($main['date_of_inspection'])) ?>"
                              <?= $main["status_inspection"] == 0 ? '' : 'readonly' ?>>
                          </div>
                          <div class="col-2">
                            <input class="form-control" type="time" name="time_of_inspection"
                        ...
                        <center>
                          <div id='example1'>
                            ...
                            <table border="0px" style="border-collapse: collapse !important;padding:10px;" width="100%">
                              <tr colspan="17">
                                <td
                                  style="text-align: left; padding: 5px;width: 20% !important;vertical-align: middle !important;">
                                  <img src="<?= base_url() ?>img/seatrium-logo.png" style="width: 170px; zoom: 2;">
                                </td>
                                <td
                                  style="text-align: center; padding: 5px;width: 60% !important;vertical-align: middle !important;">
                                  <h3><?= $project['description'] ?></h3>
                                </td>
                                <td
                                  style="text-align: right; padding: 5px;width: 20% !important;vertical-align: middle !important;">
                                  <img src="<?= $project['client_logo'] ?>" style="width: 120px;">
                                </td>
                              </tr>
                            </table>

                            <table border="1px" style="border-collapse: collapse !important;padding:20px !important;"
                              width="100%">
                              <tr class="bg-gray-table">
                                <th style="text-align:center; vertical-align: middle;">S/N</th>
                                <th style="text-align:center; vertical-align: middle;">Weld Map Dwg / Line & Spool No
                                </th>
                                ...
                                <th style="text-align:center; vertical-align: middle; width: 100px !important;">Result
                                </th>
                              ...
                              <?php foreach ($detail as $key => $value) { ?>
                                <tr style="text-align: center; vertical-align: middle;">
                                  ...
                                  <td>
                                    <?= $joint[$value['id_joint']]['joint_no'] . ($value['revision'] > 0 ? '(' . $value['revision_category'] . $value_rere['revision'] . ')' : '') ?>
                                  </td>
                                  ...
                                  <?php if ($key == 0) { ?>
                                    <td rowspan="<?= COUNT($detail) ?>" style="vertical-align: middle;">
                                      ACC <input type="radio" <?= $main['result'] == 1 ? 'checked' : '' ?> name="result"
                                        value="1">
                                      <br>
                                      REJ <input type="radio" <?= $main['result'] == 2 ? 'checked' : '' ?> name="result"
                                        value="2">
                                    </td>
                                  <?php } ?>
                                  <td>
                                    <input class="form-control" type="text" name="remarks[<?= $value['pwht'] ?>]"
                                      value=<?= $value['remarks'] ?>>
                                  </td>
                                </tr>
                              <?php } ?>
                            ...
                            <table border="1px" style="border-collapse: collapse !important;padding:20px !important;"
                              width="100%">
                              <tr>
                                <td colspan="3" style="text-align:center; border: 0px">Tested by<br> NDT Level II</td>
                                <td colspan="3" style="text-align:center; border: 0px">QC Inspector<br> (DSAW)</td>
                                <td colspan="2" style="text-align:center; border: 0px">QC Inspector<br> (SEATRIUM)</td>
                                <td colspan="5" style="text-align:center; border: 0px">Client<br> Inspector</td>
                                <td colspan="5" style="text-align:center; border: 0px">3rd party</td>
                              </tr>
                              ...
                              <tr>
                                <td colspan="3" style="text-align:center ;border-left: 0px; border-right: 0px">
                                  <?php if ($main["status_inspection"] >= 1 or $main['tested_by']) { ?>
                                    <img src="data:image/png;base64,<?= $user[$main['tested_by']]['sign_approval'] ?>"
                                      style='width: 4.5cm;vertical-align: text-bottom !important;' />
                                  <?php } ?>
                                  <?php if ($main['status_inspection'] == 0 and !$main['tested_by']) { ?>
                                    <span class="btn btn-success"
                                      onclick="approve_request('<?= $main['uniq_id_report'] ?>', 0)">
                                ...
                                <td colspan="3" style="text-align:center ;border-left: 0px; border-right: 0px">
                                  <?php if ($main["qc_subcont_by"]) { ?>
                                    <img src="data:image/png;base64,<?= $user[$main['qc_subcont_by']]['sign_approval'] ?>"
                                      style='width: 4.5cm;vertical-align: text-bottom !important;' />
                                  <?php } ?>
                                  <?php if ($main['status_inspection'] == 13) { ?>
                                    <span class="btn btn-success"
                                      onclick="approve_request('<?= $main['uniq_id_report'] ?>', 15)">
                                      <i class="fas fa-check"></i>
                                      Approve QC (DSAW)
                                    </span>
                                  <?php } ?>
                                </td>
                                <td colspan="2" style="text-align:center ;border-left: 0px; border-right: 0px">
                                  <?php if ($main["qc_by"]) { ?>
                                    <img src="data:image/png;base64,<?= $user[$main['qc_by']]['sign_approval'] ?>"
                                      style='width: 4.5cm;vertical-align: text-bottom !important;' />
                                  <?php } ?>
                                  <?php if ($main['status_inspection'] == 1 or $main['status_inspection'] == 15) { ?>
                                    <span class="btn btn-success"
                                      onclick="approve_request('<?= $main['uniq_id_report'] ?>', 3)">
                                      <i class="fas fa-check"></i>
                                      Approve QC (SEATRIUM)
                                    </span>
                                  <?php } ?>
                                ...
                                <td colspan="5" style="text-align:center ;border-left: 0px; border-right: 0px">
                                  <?php if ($main["client_by"]) { ?>
                                    <img src="data:image/png;base64,<?= $user[$main['client_by']]['sign_approval'] ?>"
                                      style='width: 4.5cm;vertical-align: text-bottom !important;' />
                                  <?php } ?>
                                  <?php if ($main['status_inspection'] == 5) { ?>
                                    <span class="btn btn-success"
                                      onclick="approve_request('<?= $main['uniq_id_report'] ?>', 7)">
                                      <i class="fas fa-check"></i>
                                      Approve Client
                                    </span>
                                  <?php } ?>
                              ...
                              <tr style="border: none !important;">
                                ...
                                <td colspan="6" style="border: none !important;">: Linear - Lack of Penetration/Lack of
                                  Fusion/Crack</td>
                              ...
                              <tr style="border: none !important;">
                                ...
                                <td colspan="6" style="border: none !important;">: Rounded - Slag of Inclusion/Porosity
                                </td>
                                <td colspan="2" style="border: none !important;"></td>
                            ...
                            <br />
                            <?php if (in_array($main['status_inspection'], [0, 1, 2, 3, 9, 12, 13, 14, 15]) or $this->permission_cookie[0] == 10001) { ?>
                              <button type="submit" class="btn btn-warning" name="status_inspection"
                                value="<?= $main['status_inspection'] != 0 ? $main['status_inspection'] : 0 ?>"><i
                            ...
                            <?php if (
                              ...
                              <span type="button"
                                onclick="approve_request('<?= $main['uniq_id_report'] ?>', <?= $joint[$main["id_joint"]]["company_id"] == 5 ? 13 : 1 ?>)"
                                class="btn btn-info"><i class="fas fa-exchange-alt"></i> Submit to QC
                                <?= $joint[$main["id_joint"]]["company_id"] == 5 ? '(DSAW)' : '(SEATRIUM)' ?></span>
                            <?php } ?>
                            <?php if ($main["status_inspection"] == 3) { ?>
                              <span type="button" onclick="approve_request('<?= $main['uniq_id_report'] ?>', 5)"
                                class="btn btn-info"><i class="fas fa-exchange-alt"></i> Submit to Client</span>
                            <?php } ?>
                            <br />
                          </div>
                      </form>
                ...
                <div id="menu2" class="container tab-pane col-md-12 fade"><br>
                  <div class="col-md-12">
                    <div class="col-md-6">
                      <form action="<?php echo base_url('ndt_live/upload_new_attachment/9'); ?>" method="post"
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" name="submission_id" id="uniq_data"
                                value="<?= $main['uniq_id_report'] ?>" autocomplete="off" readonly>
                              <input type="hidden" class="form-control" name="report_number" id="uniq_data"
                                value="<?= $main['report_no'] ?>" autocomplete="off" readonly>
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <tbody>
                          ...
                          <?php foreach ($data_attachment as $value) { ?>
                            <tr>
                              <td>
                                <a target="_blank"
                                  href="<?= base_url('ndt/open_atc/') . $value["filename"] . '/' . $value["filename"] ?>"><?php echo $value["filename"] ?></a>
                              </td>
