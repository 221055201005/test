  ...
  <table class="table table-bordered text-center ">
    <tbody>
      ...
      foreach ($deck_list as $key => $value) : ?>
        ...
        $total_lg_qc          = @$total_length_vs[$value['id']]["approved_by_qc"] + 0;
        $total_lg_pending_qc    = @$total_length_vs[$value['id']]["pending_approval"] + 0;
        $total_lg_outstanding   = @$total_length_vs[$value['id']]["outstanding_resubmit"] + 0;
        $total_lg_waiting       = @$total_length_vs[$value['id']]["waiting_submit"] + 0;
    ...
    <table class="table table-bordered text-center ">
      <tbody>
        ...
        foreach ($deck_list as $key => $value) : ?>
          ...
          $total_lg_qc            = @$total_length_vs_by_class[$value['id']][$class['id']]["approved_by_qc"] + 0;
          $total_lg_pending_qc    = @$total_length_vs_by_class[$value['id']][$class['id']]["pending_approval"] + 0;
          $total_lg_outstanding   = @$total_length_vs_by_class[$value['id']][$class['id']]["outstanding_resubmit"] + 0;
          $total_lg_waiting       = @$total_length_vs_by_class[$value['id']][$class['id']]["waiting_submit"] + 0;
