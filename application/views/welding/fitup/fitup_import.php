...
<div id="content" class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <form method="POST" action="<?php echo base_url(); ?>we_dept/fitup_import_preview/<?php echo strtr($this->encryption->encrypt($rfi_id_list), '+=/', '.-~') ?>" enctype="multipart/form-data">
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="pb-2 mb-0">Import - Fitup Inspection - Fabrication Mode</h6>
        <div class="overflow-auto media text-muted py-3 mt-1 border-bottom border-top border-gray">
          <div class="container-fluid">
            <div class="form-group row">
              <label class="col-sm-2 col-form-label">Template Excel</label>
              <div class="col-sm-10 col-form-label">
                <a href="<?php echo base_url(); ?>file/welding/Template_Fitup_Inspection_Rev01.xlsx" class='btn btn-primary'><i class="fas fa-file-excel"></i> Template_Fitup_Inspection_Rev01.xlsx</a>
              </div>
            </div>
            <div class="form-group row">
