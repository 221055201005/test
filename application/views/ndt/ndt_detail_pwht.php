          ...
          <div class="container-fluid">
            <table width="100%" class="table table-bordered">
              <form method="POST" action="<?= base_url('ndt/insert_ndt_rfi/').$initial ?>">
                <thead>
                  <tr>
                    <th class="text-center align-middle" colspan="17"><img src="<?= base_url() ?>img/header_report.png">
                    </th>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name=""
                        value="<?= $project[$list_detail[0]['project_code']]['client'] ?>" disabled></th>

                    <th colspan="2">RFI No.</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="" value="<?= $project[$list_detail[0]['project_code']]['project_ref'].'-OCP-SMO-'.strtoupper($type_of_module_list[$list_detail[0]['type_of_module']]['code']).'-'.strtoupper($discipline_list[$list_detail[0]['discipline']]['initial']).'-NDT-RFI-'.$initial.'-'.str_pad($list_detail[0]['ndt_rfi'],4,0, STR_PAD_LEFT) ?>" disabled></th>
                  </tr>
                  <tr>
                    <th colspan="3">Project</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name=""
                        value="<?= $project[$list_detail[0]['project_code']]['project_name'] ?>" disabled></th>

                    <th colspan="2">Date of Inspection</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name=""
                        value="<?= DATE('Y-m-d', strtotime($list_detail[0]['date_of_inspection'])) ?>" disabled></th>
                  </tr>
                  <tr>
                    ...
                    <th colspan="5">
                      <input class="form-control" type="text" name="" disabled=""
                        value="<?= $list[0]['discipline']==2 ? 'DNVGL-CG-0051 / BS EN ISO 17638' : 'ASME B31.3' ?>">
                    </th>

                    <th colspan="2">Testing Location</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5">
                      <select class="form-control" name="testing_location">
                        <option>---</option>
                  ...
                  <tr>
                    ...
                    <th colspan="5">
                      ...
                      <input class="form-control" type="text" name="acceptance_criteria" readonly=""
                        value="ASME B31.3 Paragraph 344.4.2">
                      <?php } else { ?>
                      <select class="form-control" name="acceptance_criteria" readonly>
                        <option>---</option>
                        <option value="ISO 5817 LEVEL B" <?= $list_detail[0]['class']==1 ? 'selected' : '' ?>>ISO 5817
                          LEVEL B</option>
                    ...
                    <th colspan="2" rowspan="2" class="align-middle">PWHT</th>
                    <th colspan="1" rowspan="2" class="align-middle">:</th>
                    <th colspan="5" rowspan="2" class="align-middle">
                      <input class="form-control" type="text" name=""
                        value="<?= @$list[0]['pwht_status']==1 ? 'YES' : 'NO' ?>" readonly>
                    </th>
                  </tr>
                  <tr>
                    <th colspan="5">
                      <?php if($list[0]['discipline']==1){ ?>
                      <input class="form-control" type="text" name="acceptance_criteria" readonly=""
                        value="ASME B31.3 Paragraph 344.3.2">
                      <?php } else { ?>
                      <select class="form-control" name="acceptance_criteria" readonly>
                        <option>---</option>
                        <option value="ISO 23278 ACCEPTANCE LEVEL 2X"
                          <?= $list_detail[0]['class']==1 ? 'selected' : '' ?>>ISO 23278 ACCEPTANCE LEVEL 2X</option>
                        <option value="ISO 23278 ACCEPTANCE LEVEL 2X"
                          <?= in_array($list_detail[0]['class'], [2, 3]) ? 'selected' : '' ?>>ISO 23278 ACCEPTANCE LEVEL
                          2X</option>
                      </select>
                      <?php } ?>
                    </th>
                  ...
                  <tr>
                    ...
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="procedure_no"
                        value="<?= $list[0]['discipline']==2 ? 'SCM-SOF-SMOE-23-PR-0007': 'SCM-SOF-SMOE-23-PR-0011' ?>"
                        readonly></th>

                    <th colspan="2">Job No.</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="job_no"
                        value="<?= @$report_detail['job_no'] ?>"></th>
                  ...
                  <tr>
                    ...
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="" disabled=""
                        value="<?= $list[0]['drawing_no'] ?>"></th>
                    <th colspan="2">Item Tested</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="item_tested"
                        value="<?= @$report_detail['item_tested'] ?>"></th>
                  </tr>
                  <tr>
                    <th colspan="3" rowspan="1" class="align-middle">Job Description</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="5" rowspan="1" class="align-middle">
                    ...
                    <th colspan="2" rowspan="1" class="align-middle">Viewing Condition</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="5" rowspan="1" class="align-middle"><input class="form-control" type="text"
                        name="viewing_condition" value="<?= @$report_detail['viewing_condition'] ?>"></th>
                  </tr>

                  <tr>
                    <th class="align-middle" colspan="3" rowspan="4">Type of Magnetization Equipment User</th>
                    <th rowspan="1" colspan="1">Brand :</th>
                    <th colspan="5"><input class="form-control" type="text" name="brand"
                        value="<?= @$report_detail['brand'] ?>"></th>

                    <th colspan="2" rowspan="1" class="align-middle">Surface Condition</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="5" rowspan="1" class="align-middle"><input class="form-control" type="text"
                        name="surface_condition" value="<?= @$report_detail['surface_condition'] ?>"></th>
                  </tr>

                  <tr>
                    <th rowspan="1" colspan="1">Model :</th>
                    <th colspan="5"><input class="form-control" type="text" name="model"
                        value="<?= @$report_detail['model'] ?>"></th>
                    ...
                    <th colspan="2" rowspan="1" class="align-middle">Surface Temperature</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="5" rowspan="1" class="align-middle"><input class="form-control" type="text"
                        name="temperature" value="<?= @$report_detail['temperature'] ?>"></th>
                  </tr>

                  <tr>
                    <th rowspan="1" colspan="1">Serial No :</th>
                    <th colspan="5"><input class="form-control" type="text" name="serial_no"
                        value="<?= @$report_detail['serial_no'] ?>"></th>

                    <th colspan="2" rowspan="1" class="align-middle">Applying Current</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="applying_current" value="continuous"
                        <?= $report_detail['applying_current']=='continuous' ? 'checked' : '' ?>> Continuous
                    </th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="applying_current" value="residual"
                        <?= $report_detail['applying_current']=='residual' ? 'checked' : '' ?>> Residual
                    </th>
                    <th></th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <th colspan="5"><input class="form-control" type="text" name="sensitivity"
                        value="<?= @$report_detail['sensitivity'] ?>"></th>

                    <th colspan="2" rowspan="1" class="align-middle">Magnetic Current</th>
                    <th colspan="1" rowspan="1" class="align-middle">:</th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="magnetic_current" value="ac"
                        <?= $report_detail['magnetic_current']=='ac' ? 'checked' : '' ?>> AC
                    </th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="magnetic_current" value="dc"
                        <?= $report_detail['magnetic_current']=='dc' ? 'checked' : '' ?>> DC
                    </th>
                    <th></th>
                  </tr>

                  <tr>
                    <th colspan="3">Delivery Condition</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="delivery_condition"
                        value="<?= @$report_detail['delivery_condition'] ?>"></th>

                    <th colspan="2">Consumable Brand</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="consumable_brand"
                        value="<?= @$report_detail['cosumable_brand'] ?>"></th>
                  </tr>

                  <tr>
                    <th colspan="3">Grade Material</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="grade_material"
                        value="<?= @$report_detail['grade_material'] ?>"></th>

                    <th colspan="2">Batch Number</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="batch_number"
                        value="<?= @$report_detail['batch_number'] ?>"></th>
                  </tr>

                  <tr>
                    <th colspan="3">Testing Personnel</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="technician"
                        value="<?= @$report_detail['testing_personnel'] ?>"></th>

                    <th colspan="2">Medium</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="medium"
                        value="<?= @$report_detail['medium'] ?>"></th>
                  </tr>

                  <tr>
                    <th colspan="3">Certificate No.</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="certificate_no"
                        value="<?= @$report_detail['certificate_no'] ?>"></th>

                    <th colspan="2">Background</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5"><input class="form-control" type="text" name="background"
                        value="<?= @$report_detail['background'] ?>"></th>
                  </tr>

                  <tr>
                    <th colspan="9" rowspan="3" class="align-top">
                      <textarea class="form-control" placeholder="Acceptable to Specification"
                        name="acceptable_to_pecification"
                        rows="5"><?= @$report_detail['acceptable_to_pecification'] ?></textarea>
                    </th>

                    <th colspan="2">Demagnetization</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="demagnetization" value="yes"
                        <?= $report_detail['demagnetization']=='yes' ? 'checked' : '' ?>> YES
                    </th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="demagnetization" value="no"
                        <?= $report_detail['demagnetization']=='no' ? 'checked' : '' ?>> NO
                    </th>
                    <th></th>
                  </tr>

                  <tr>
                    <th colspan="2">Applicable Partcicle</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="applicable_particle" value="wet"
                        <?= $report_detail['applicable_particle']=='wet' ? 'checked' : '' ?>> WET
                    </th>
                    <th colspan="2" rowspan="1" class="align-middle">
                      <input type="radio" name="applicable_particle" value="dry"
                        <?= $report_detail['applicable_particle']=='dry' ? 'checked' : '' ?>> DRY
                    </th>
                    <th></th>
                  </tr>

                  <tr>
                    <th colspan="2">Yoke Expire Calibration Date</th>
                    <th colspan="1" class="align-middle">:</th>
                    <th colspan="5" rowspan="1" class="align-middle">
                      <input type="date" class="form-control" name="yoke_expire_calibration_date"
                        value="<?= DATE('Y-m-d', strtotime($report_detail['yoke_expire_calibration_date'])) ?>">
                    </th>
                  </tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center"><?= $value[0]['drawing_wm'] ?>
                    </td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center">
                      <?= $value[0]['joint_no'].$value[0]['revision_category'].$value[0]['revision'] ?></td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center">
                      <?= $joint_type[$value[0]['joint_type']] ?></td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center"><?= $value[0]['diameter'] ?>
                    </td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center"><?= $value[0]['sch'] ?></td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center"><?= (int)$value[0]['thk'] ?>
                    </td>
                    <td rowspan="<?= count($value) ?>" class="align-middle text-center"><?= $value[0]['total_length'] ?>
                    </td>
              ...
              <div class="text-right">
                <?php if($condition=='approval_client'){ ?>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <textarea class="form-control" placeholder="Remarks" style="right: 0px !important" name="approval_remarks"></textarea>
                    </div>
                  </div>
                  <?php } else {
                                ...
                                <div class="input-group mb-3">
                                  <select id='ctq_id_<?= $value["id"]; ?>' class="form-control">
                                    ...
                                    <option value="<?php echo $valuex['id']; ?>">
                                      <?php echo $valuex["ctq_description"]; ?> ( <?php echo $valuex["ctq_initial"]; ?>
                                      )</option>
                                    <?php } ?>
                                  </select>
                                  ...
                                  <input type='number' step='any' class='form-control ctq_rejected'
                                    id='ctq_datum_<?= $value["id"]; ?>' placeholder='Distance from Datum'>
