                  ...
                  <tr>
                    ...
                    <td>
                      <?php if($status_revise=='approved'){ ?>
                        <a href="<?= base_url('ndt/ndt_update_v2/').$value['submission_id'].'/'.$status_revise_id ?>" class="mt-2 btn btn-sm btn-primary">
                      ...
                      <?php } elseif ($status_revise=='reapproval') { ?>
                        <a href="<?= base_url('ndt/ndt_detail_v2/').$value['submission_id'].'/reapproval_request_for_update' ?>" class="mt-2 btn btn-sm btn-primary">
                          <i class="fas fa-list"></i>
                          Approve
                        </a>
                      <?php } ?>
