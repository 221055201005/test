    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card shadow my-3">
          ...
          <div class="card-body">
            <form action="<?= site_url('bondstrand/client_approval_process') ?>" method="post">
              <div class="row">
                <div class="col-md-6">
                            ...
                            <table class="table table-bordered table-sm table-hover text-center">
                              ...
                              <tbody>
                                ...
                                foreach ($list as $key => $value) : ?>
                                  <tr>
                                    <td>
																			<?php if($value['status_inspection'] == 5 && $this->user_cookie[7] == 8): ?>
																				...
																				<br>
																				<div class='client_remarks d-none' id="clnt_rmks_<?php echo $key; ?>">
																					Client Remarks : <br/>
...
<script>
  ...
  `
	...
	function change_single_button(mode,no){
      ...
      $("textarea[name='client_remarks["+no+"]']").prop('disabled', false);
    } else {
      $("#clnt_rmks_"+no).addClass('d-none')
      $("textarea[name='client_remarks["+no+"]']").prop('disabled', true);
    }
	}
...
function change_all_button(mode){
	...
	if(mode==6){
		...
		$(".client_remarks textarea").prop('disabled', false);
	} else if(mode==7){
		$(".rejected").prop('checked', false);
		$(".approved").prop('checked', true);
		$(".client_remarks").addClass('d-none');
		$(".client_remarks textarea").prop('disabled', true);
	} else {
		$(".approved").prop('checked', false);
		$(".rejected").prop('checked', false);
		$(".client_remarks").addClass('d-none');
