      ...
      <tbody>
        ...
        foreach ($list as $key => $value) : ?>
          ...
          <tr>
            ...
            <td><?= $value['adhesive_time_start'] ? date('h:i A', strtotime($value['adhesive_time_start'])) :'-' ?></td>
            <td><?= $value['adhesive_time_stop'] ? date('h:i A', strtotime($value['adhesive_time_stop'])) : '-' ?></td>
            ...
            <td>
              <?= $value['curing_start'] ? date('h:i A', strtotime($value['curing_start'])) :'-' ?>
            </td>

            <td>
              <?= $value['curing_finish'] ? date('h:i A', strtotime($value['curing_finish'])) :'-' ?>
            </td>
