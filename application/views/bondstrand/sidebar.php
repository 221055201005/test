...
<?php if ($this->user_cookie[7] != 8) : ?>
  ...
  <div class="col-md-2">
    <ul class="list-group sidebar-group">
      ...
      <li class="list-group-item"><i class="d-none fas fa-caret-right"></i> 
        <a style="color: black" href="<?= site_url('bondstrand/inspection_list/' . strtr($this->encryption->encrypt('0'), '+=/', '.-~')) ?>">
          <i class="fas fa-caret-right"></i>  &nbsp; Inspection List RFI
        </a>
      </li>
      <li class="list-group-item"><i class="d-none fas fa-caret-right"></i> 
        <a style="color: black" href="<?= site_url('bondstrand/inspection_list/' . strtr($this->encryption->encrypt('1'), '+=/', '.-~')) ?>">
  ...
  <div class="col-md-2">
    <ul class="list-group sidebar-group">
      ...
      <li class="list-group-item">
        <a style="color: black" href="<?= site_url('bondstrand/transmittal_rfi') ?>">
  ...
  <div class="col-md-2">
    <ul class="list-group sidebar-group">
      ...
      <li class="list-group-item">
        <a style="color: black" href="<?= site_url('bondstrand/bondstrand_summary') ?>">
          <i class="fas fa-caret-right"></i>  &nbsp; Summary RFI
        </a>
      </li>

      <li class="list-group-item">
        <a style="color: black" href="<?= site_url('bondstrand/third_party_list') ?>">
          <i class="fas fa-caret-right"></i>  &nbsp; Bondstrand Third Party
        </a>
      </li>
...
<div class="col-md-2">
  <ul class="list-group sidebar-group">
    ...
    <li class="list-group-item">
      <a style="color: black" href="<?= site_url('bondstrand/request_for_update_list/' . strtr($this->encryption->encrypt('waiting_approval'), '+=/', '.-~')); ?>">
    ...
    <li class="list-group-item">
      <a style="color: black" href="<?= site_url('bondstrand/request_for_update_list/' . strtr($this->encryption->encrypt('approved_for_update'), '+=/', '.-~')); ?>">
        <i class="fas fa-caret-right"></i>  &nbsp; Approved for Update
      </a>
    </li> 

    <li class="list-group-item">
      <a style="color: black" href="<?= site_url('bondstrand/request_for_update_list/' . strtr($this->encryption->encrypt('re_approval'), '+=/', '.-~')); ?>">
        <i class="fas fa-caret-right"></i>  &nbsp; Re-Approval Inspector
      </a>
    </li> 

    <li class="list-group-item">
      <a style="color: black" href="<?= site_url('bondstrand/request_for_update_list/' . strtr($this->encryption->encrypt('closed'), '+=/', '.-~')); ?>">
