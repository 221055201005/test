        ...
        <div class="card-body bg-white overflow-auto">
          <form action="" method="GET">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group row">
                  <label class="col-md-4 col-lg-3 col-form-label font-weight-bold">NDT Sequence</label>
                  <div class="col-xl">
                    <select class="chooser" style="height: 30px !important" multiple="" name="ndt_sequence[]" required="">
                      <option value="1">Radiographic Testing</option>
                      <option value="2">Magnetic Particle Testing</option>
                      <option value="3">Ultrasonic Testing</option>
                      <option value="4">PA Ultrasonic Testing</option>
                      <option value="5">Hardness Testing</option>
                      <option value="6">Ferrite Testing</option>
                      <option value="7">Penetrant Testing</option>
                      <option value="8">Positif Material Testing</option>
                      <option value="9">PWHT Testing</option>
                    </select>
                  </div>
                </div>
                <script type="text/javascript">
          ...
          <form method="POST" action="<?php echo base_url() ?>ndt/send_to_vendor">
            ...
            <div class="col-6">
                <div class="row card">
                  <div class="col">
                    ...
                    <hr>
                    <center>
                      <?php foreach ($get['ndt_sequence'] as $key => $value) { ?>
                        <input type="hidden" name="ndt_sequence[]" value="<?= $value ?>">
                        <span class="btn btn-primary align-middle">
                          <?= $ndt[$value]['ndt_description'] ?>
                        </span>
                        <?= $key==COUNT($get['ndt_sequence'])-1 ? "" : "<h4 class='fas fa-angle-double-right align-middle'></h4>" ?>
                      <?php } ?>
                    </center>
                    <br>
                  </div>
              ...
              <table class="table table-hover text-center dataTable" width="100%">
                ...
                <tbody>
                  ...
                  <tr <?= $submitted=='submitted' ? (strtotime(DATE('Y-m-d H:i:s'))-strtotime($value['ndt_transmittal_datetime'])>43200 ? 'class=""' : '') : '' ?> >
                    ...
                    <td>
                    <?php if(COUNT(explode(';',$value['ndt_sequence']))>0){ ?>
                      <?php foreach (explode(';',$value['ndt_sequence']) as $keys => $values) { ?>
                        <span class="btn btn-primary align-middle">
                          <?= $ndt[$values]['ndt_initial'] ?>
                        </span>
                        <?= $keys==COUNT(explode(';',$value['ndt_sequence']))-1 ? "" : "<h4 class='fas fa-angle-double-right align-middle'></h4>" ?>
                      <?php } ?>
                    <?php } else { ?>
                      N/A
                    <?php } ?>
            ...
            <div class="col-md-4">
              <div class="row mb-1">
                <div class="col-md-12">
                  <?php if($submitted!='submitted'){ ?>
                    <button type="submit" name="submit" value="draft" class="btn btn-primary submit <?= $show==1 ? '' : 'd-none' ?>"><i class='fas fa-paper-plane'></i> Send to Vendor</button>
                  <?php } ?>
                </div>
              </div>
            </div>
