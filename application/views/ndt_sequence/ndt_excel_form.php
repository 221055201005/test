    ...
    <div class="col">
      <div class="card shadow my-3 rounded-0">
        ...
        <div class="card-body bg-white overflow-auto">
          <form action="<?php echo base_url(); ?>/ndt/ndt_export/<?= $initial ?>" method="POST">
            <div class="row">
               <div class="col-6">
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group row">
                  ...
                  <div class="col-xl">
                    <?php //test_var($this->user_cookie, 1); ?>
                    <?php //test_var($vendor_rfi); ?>
                    <select class="form-control select2" name="company[]" style="<?= $this->user_cookie[11]==1 ? '' : 'pointer-events: none;' ?>">
