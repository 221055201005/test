...
<div id="content" class="container-fluid">
	...
	<form method="POST" action="<?= base_url('additional/update_rfi_process') ?>" enctype="multipart/form-data">
		<input type="hidden" name="submission_id" class="form-control" value="<?= $rfi['submission_id'] ?>" required>
			...
			<div class="card shadow my-3 rounded-0">
				...
				<div class="card-body bg-white">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-xl">
											<input type="text" name="report_no" class="form-control" value="<?= $dc['report_number'] ?>" required>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group row">
										<label for="" class="col-xl-3 col-form-label text-muted">Report Attachment</label>
										<div class="col-xl">
								...
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-xl">
											<input type="date" name="inspection_actual_date" class="form-control" value="<?= $rfi['inspection_actual_date'] ?? '' ?>">
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group row">
										...
										<div class="col-xl">
											<input type="date" name="submitted_date" class="form-control" value="<?= $rfi['submitted_date'] != '' ? date("Y-m-d", strtotime($rfi['submitted_date'])) : '' ?>">
										</div>
									</div>
								</div>
					...
					<table class="table table-bordered table-hover" id="tbl_rfi_detail">
						...
						<tbody>
							<?php foreach ($dc_list as $key => $value) { ?>
								<tr style='text-align:center;'>
									...
									<!-- <td><?= $value["pos_1"] ?><br/><?= $value["pos_2"] ?></td>  -->
					...
					<div class="row">
						<div class="col-md">
							...
							<a target="_blank" href="<?= base_url() ?>additional/rfi_other_pdf/<?= strtr($this->encryption->encrypt($dc['type_of_report']), '+=/', '.-~') ?>/<?= strtr($this->encryption->encrypt($dc['submission_id']), '+=/', '.-~') ?>" title='RFI PDF' class='btn btn-sm btn-dark'><i class="fa fa-file-pdf"></i> RFI PDF</a>
						</div>
