      ...
      <div class="col-md-12">
        <div class="card border-0 shadow-sm my-3">
          <div class="card-body">
            ...
            <hr>
            <form action="<?= site_url('fitup/preview_update_ecodoc') ?>" method="post" enctype="multipart/form-data">
              <div class="row">
...
<script>
  ...
  function generate_template(btn) {
    ...
    window.location.href = "<?= site_url('fitup/template_file_ecodoc/') ?>?deck_elevation=" + deck_elevation
  }
</script>