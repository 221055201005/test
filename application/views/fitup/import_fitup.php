    ...
    <div class="col">
      <div class="card shadow my-3 rounded-0">
        ...
        <div class="card-body bg-white overflow-auto">
          <form method="POST" action="<?php echo base_url(); ?>fitup/import_preview" enctype="multipart/form-data">
            <div class="form-group row">
              <label class="col-md-4 col-lg-3 col-form-label font-weight-bold">Template Excel</label>
              <div class="col-xl col-form-label">
                <a target="_blank" href="<?php echo base_url('fitup/generate_template_import'); ?>">Template_Import_Fitup.xlsx</a>
              </div>
            </div>
            <div class="form-group row">
