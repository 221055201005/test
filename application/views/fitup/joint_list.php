...
if (@$get['project'] == 21) {
  if (@$get['deck_elevation'] == '') {
    $is_all_fill = false;
  }
}
if (@$get['status_inspection'] == '') {
  $is_all_fill = false;
}
?>
<style type="text/css">
  ...
  <?php if (isset($joint_list)) { ?>
    ...
    <?php if ($mode != 'transmittal') { ?>
      ...
      <form action="<?php echo base_url(); ?>fitup/insert_data_fitup" method='POST' id="form_submition">
        ...
        <?php if (sizeof($joint_list) > 0 and isset($get['project']) && isset($get['drawing_no']) && !empty($get['drawing_no']) && isset($get['drawing_wm']) && !empty($get['drawing_wm']) && $is_all_fill) { ?>
                        ...
                        <div class="col-xl">
                          <select class="select2 will_enable" name="area" required>
                            ...
                            <?php foreach ($area_name_list_v2 as $value_area) { ?>
                              <option value="<?= $value_area['id'] ?>" <?php if ($joint_list[0]['area_v2'] == $value_area['id']) {
                                                                          echo "selected";
                        ...
                        <div class="col-xl">
                          <select class="select2 will_enable" name="location" required>
                            ...
                            <?php foreach ($location_name_list_v2 as $value_location) { ?>
                              <option value="<?= $value_location['id'] ?>" data-chained="<?php echo $value_location['id_area'] ?>" <?php if ($joint_list[0]['location_v2'] == $value_location['id']) {
                                                                                                                                      echo "selected";
                        ...
                        <div class="col-xl">
                          <select class="select2 will_enable" name="point">
                            ...
                            <?php foreach ($point_list as $value_point) { ?>
                              ...
                              <option value="<?= $value_point['id'] ?>" data-chained="<?php echo $value_point['id_location'] ?>" <?php if ($joint_list[0]['point_v2'] == $value_point['id']) {
                                                                                                                                    echo "selected";
      ...
      <?php } else { ?>
        ...
        <?php if ((@$get['status_inspection'] != '6' and @$get['status_inspection'] != '11' and @$get['status_inspection'] != '9')) { ?>
          ...
          <?php } else if (@$get['status_inspection'] == '11' or @$get['status_inspection'] == '9') { ?>
            ...
            <input type="hidden" name='status_inspection' value="<?php echo @$get['status_inspection']; ?>">
                  ...
                  <div class="card-body bg-white">
                    ...
                    <?php if ($mode == "transmittal" && isset($drawing_fltr)) : ?>
                      <div class="row">
                        ...
                        <?php $array_user_allowed = array(1, 1000367, 1000129, 1001385, 1000202, 1000392, 1000369, 1001551);
                        if (in_array($this->user_cookie[0], $array_user_allowed) && $get['discipline'] == 1) { ?>
                          <div class="col-md-8 mt-2">
                            <div class="form-group row">
                    ...
                    <?php if ($get['project'] || $get['drawing_no'] && $get['drawing_wm']) : ?>
                            ...
                            <?php if (sizeof($joint_list) > 0) { ?>
                              ...
                              foreach ($joint_list as $key => $value) : ?>
                                ...
                                if (isset($value['status_inspection'])) {
                                  ...
                                  $pID = $value['pos_1'] . ";" . $value['pos_2'];
                                  $validation = explode(";", $pID);

                                  foreach ($validation as $partID) {
                                    if (isset($status_piecemark[$partID]['id_mis'])) {
                                      if ($status_piecemark[$partID]['status_inspection'] == '0') {
                                        $status_data = 2;
                                      } else {
                                        $status_data = 3;
                                      }
                                ...
                                <tr <?php if (@$get['status_inspection'] == 'null' and $status_data == '2') { ?>style="display: none;" <?php } else if (@$get['status_inspection'] == 'x' and $status_data == '3') { ?>style="display: none;" <?php } ?>>
                                    ...
                                    <td>
                                      ...
                                      <?php if ($mode != 'transmittal' && (isset($get['drawing_wm']) && !empty($get['drawing_wm']))) { ?>
                                        ...
                                        ?>
                                          ...
                                          $validation = explode(";", $pID);
                                          foreach ($validation as $partID) {
                                            if (!in_array($status_piecemark[$partID]['status_inspection'], [3, 5, 7, 9, 10, 11])) {
                                              $status_show_data_submit = 0;
                                            }
                                          }
                                      ...
                                      <?php } else { ?>
                                        ...
                                        foreach ($validation as $partID) {
                                          if (in_array($status_piecemark[$partID]['status_inspection'], $status_ok)) {
                                            $statsx[] = "ok";
                                          } else {
                                            $statsx[] = "noOK";
                                          }
                                  ...
                                  <td>
                                    ...
                                    <?php if ($mode != 'transmittal') { ?>
                                      ...
                                      <?php if (isset($activity_eng[$value['drawing_no']]['id'])) { ?>
                                        ...
                                        ?>
                                        <br />
                                        <a target='_blank' href='<?= $links_atc ?>' title='Attachment'>
                                          <h6> <span class="badge badge-pill badge-primary"> <i class='fas fa-paperclip'></i>
                                              Open</span> </h6>
                                        </a>
                                  ...
                                  <td>
                                    ...
                                    ?>
                                      <?php
                                      if (@$status_piecemark[$pc1]['status_inspection'] == '1') {
                                    ...
                                    ?>
                                      <?php
                                      if (@$status_piecemark[$pc2]['status_inspection'] == '1') {
                                        echo "<span class='badge badge-danger'>Pending Re-Approval</span>";
                                      }
                                      ?>
                                    <?php
                      ...
                      <?php if (isset($get['drawing_wm']) && !empty($get['drawing_wm']) && in_array(@$get['status_inspection'], ['0', '2', '4']) && $is_all_fill) { ?>
