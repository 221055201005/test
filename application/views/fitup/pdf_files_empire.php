...
<?php
if ($joint_list[0]['project_code'] == 21) {
    $suffix_no = $master_report_number_deck[$joint_list[0]['project_code']][$joint_list[0]['company_id']][$joint_list[0]['discipline']][$joint_list[0]['type_of_module']][$joint_list[0]['deck_elevation']]['fitup_report'];
} else {
...
<head>
    <title><?php if (isset($report_number)) {
                echo  $suffix_no . $report_number;
            } else {
                echo  $submission_data_id;
            } ?></title>
    <style type="text/css">
        @page {
            margin: 0cm 0cm;
...
<body>
    <header>
        ...
        <table width="100%" border="1px" style="border-collapse: collapse !important;">
            ...
            <head>
                <tr>
                    <td><b class="tab">COMPANY</b>: <?php echo strtoupper($project_data_portal[0]['client']); ?></td>
                    <td>
                        ...
                        <?php if (isset($report_number)) { ?><b class="tab2">REPORT NO.</b>: <?php echo $suffix_no . $report_number;
                                                                                            } else { ?> <b class="tab2">SUBMISSION NO.</b>: <?php echo $submission_data_id;
                                                                                                                                        } ?> <?php if ($joint_list[0]['postpone_reoffer_no'] > 0) {
                                                                                                                                                    echo "Rev. " . $joint_list[0]['postpone_reoffer_no'];
                                                                                                                                                } ?>
                ...
                <tr>
                    ...
                    <td><b class="tab">CONTRACTOR</b>: <?php if ($joint_list[0]['project_code'] == 21) echo 'SEATRIUM';
                                                        elseif ($joint_list[0]['project_code'] == 19) echo 'PT SMOE';
                                                        else echo $joint_list[0]['company']; ?></td>
                    <td><b class="tab2">DESCRIPTION</b>: <?php if (isset($eng_detail[0]['title'])) {
                                                                echo $eng_detail[0]['title'];
                                                            } ?></td>
                </tr>
                <tr>
                    <td colspan="2" class="bb bx" width="100%">
                        <center><b>FIT UP INSPECTION REPORT -
                                <?php if ($joint_list[0]['discipline'] == 2) {
                                    echo "STRUCTURAL";
                                } else if ($joint_list[0]['discipline'] == 1) {
                                    echo "PIPE";
                                } else if ($joint_list[0]['discipline'] == 32) {
                                    echo "ARCHITECTURAL";
                                } else if ($joint_list[0]['discipline'] == 74) {
                                    echo "HVAC";
                                } else if ($joint_list[0]['discipline'] == 10) {
                                    echo "ELECTRICAL";
                                } else if ($joint_list[0]['discipline'] == 75) {
                                    echo "MECHANICAL";
                                } ?></b></center>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="1" class="bb bx" width="100%" style="border-right: 0px !important">
                        <left><b>DOCUMENT / SPECIFICATION / PROCEDURE No. / REFER to :
                                <?php echo $master_acceptance[$joint_list[0]['project_code']][$joint_list[0]['company_id']][$joint_list[0]['discipline']][$joint_list[0]['module']][$joint_list[0]['type_of_module']][$joint_list[0]['class']]['fitup']['procedure']; ?>
                            </b></left>
                    </td>
                    <td colspan="1" class="bb bx" width="100%" style="border-left: 0px !important">
                        <left><b>Acceptance Criteria :
                                <?php echo $master_acceptance[$joint_list[0]['project_code']][$joint_list[0]['company_id']][$joint_list[0]['discipline']][$joint_list[0]['module']][$joint_list[0]['type_of_module']][$joint_list[0]['class']]['fitup']['acceptance_criteria']; ?>
    ...
    <table width="100%" border="0" style="text-align: left;border-collapse: collapse !important;">
        <thead>
            <tr>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 15px !important;">
                    <center><b>S/N</b></center>
                </td>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 100px !important;">
                    <center><b>Weld Map Drawing No. / Line & Spool No</b></center>
                </td>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 30px !important;">
                    <center><b>Item No./<br />Joint No</b></center>
                </td>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 50px !important;">
                    <center><b>Type<br />Of<br />Weld</b></center>
                </td>
                <td colspan="8" class="ball" style="vertical-align: middle;">
                    <center><b>Material Traceability</b></center>
                </td>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 40px !important;">
                ...
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 50px !important;">
                    <center><b>Inspection<br />Result</b></center>
                </td>
                <td rowspan="2" class="ball" style="vertical-align: middle; width: 50px !important;">
            ...
            <tr>
                <td class="ball" style="vertical-align: middle; width: 60px !important;">
                    <center><b>Desc</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 100px !important;">
                    <center><b>Piece Mark</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 70px !important;">
                    <center><b>Grade/Spec</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 130px !important;">
                    <center><b>Unique No.</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 50px !important;">
                    <center><b>Heat No.</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 40px !important;">
                    <center><b>Dia/Size</b></center>
                </td>
                <td class="ball" style="vertical-align: middle; width: 40px !important;">
                ...
                <tr>
                    ...
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        if ($value['status_inspection'] >= '5' && isset($value['drawing_wm_approved'])) {
                            // echo $value['drawing_wm_approved'] . ' Rev.' . $value['drawing_wm_rev_approved'] . ' (' . ($client_doc_no[$value['drawing_wm_approved']]) . ')' . '<br>' . (!empty($value['spool_no']) ? 'Spool No : ' . $value['spool_no'] : '');
                            echo $joint_lists[$value['id_joint']]['drawing_wm'] . ' Rev.' . $value['drawing_wm_rev_approved'] . ' (' . ($client_doc_no[$joint_lists[$value['id_joint']]['drawing_wm']]) . ')' . '<br>' . (!empty($value['spool_no']) ? 'Spool No : ' . $value['spool_no'] : '');
                        } else {
                            $text = ($value['drawing_wm']) . " Rev." . ($value['rev_wm']) . " (" . ($client_doc_no[$value['drawing_wm']]) . ")" . '<br>' . (!empty($value['spool_no']) ? 'Spool No : ' . $value['spool_no'] : '');
                            echo $text;
                        }
                        ?>
                        <!-- <?php
                    ...
                    <td class="ball" style="vertical-align: middle;text-align: center;"><?php echo $value['joint_no']
                                                                                        ?></td>
                    <td class="ball" style="vertical-align: middle;text-align: center;"><?= $weld_type_code[$value['weld_type']] ? $weld_type_code[$value['weld_type']] : "-";?></td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        <?php
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc1]["profile"] ? $status_piecemark[$pc1]["profile"] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc2]["profile"] ? $status_piecemark[$pc2]["profile"] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                    ...
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($material_grade[$status_piecemark[$pc1]["grade"]]['material_grade'] ? $material_grade[$status_piecemark[$pc1]["grade"]]['material_grade'] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($material_grade[$status_piecemark[$pc2]["grade"]]['material_grade'] ? $material_grade[$status_piecemark[$pc2]["grade"]]['material_grade'] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($warehouse_mis_mrir[$status_piecemark[$pc1]["id_mis"]]['unique_ident_no'] ? $warehouse_mis_mrir[$status_piecemark[$pc1]["id_mis"]]['unique_ident_no'] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($warehouse_mis_mrir[$status_piecemark[$pc2]["id_mis"]]['unique_ident_no'] ? $warehouse_mis_mrir[$status_piecemark[$pc2]["id_mis"]]['unique_ident_no'] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    ...
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($warehouse_mis_mrir[$status_piecemark[$pc1]["id_mis"]]['unique_ident_no'] ? $warehouse_mis_mrir[$status_piecemark[$pc1]["id_mis"]]['heat_or_series_no'] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($warehouse_mis_mrir[$status_piecemark[$pc2]["id_mis"]]['unique_ident_no'] ? $warehouse_mis_mrir[$status_piecemark[$pc2]["id_mis"]]['heat_or_series_no'] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    ...
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc1]["diameter"] ? $status_piecemark[$pc1]["diameter"] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc2]["diameter"] ? $status_piecemark[$pc2]["diameter"] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc1]["sch"] ? $status_piecemark[$pc1]["sch"] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc2]["sch"] ? $status_piecemark[$pc2]["sch"] : "-") . "</span><hr/>";
                        }
                        ?>
                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        ...
                        $pos_1  = explode(";", $value['pos_1']);
                        foreach ($pos_1 as $pc1) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc1]["thickness"] ? $status_piecemark[$pc1]["thickness"] : "-") . "</span><hr/>";
                        }
                        $pos_2  = explode(";", $value['pos_2']);
                        foreach ($pos_2 as $pc2) {
                            echo "<span class='badge'>" . ($status_piecemark[$pc2]["thickness"] ? $status_piecemark[$pc2]["thickness"] : "-") . "</span><hr/>";
                        }
                        ?>

                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        <?php echo $value['weld_length'] ? $value['weld_length'] : "-"; ?>
                    </td>

                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        <?php echo $wps_code_arr[$value['wps_no']] ? $wps_code_arr[$value['wps_no']] : "-" ?>
                    </td>

                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        <?php if ($value['status_inspection'] == "6" or $value['status_inspection'] == "2") {
                            echo "REJ";
                        } else if ($value['status_inspection'] >= 3) {
                            echo "ACC";
                        } ?>
                    </td>
                    <td class="ball" style="vertical-align: middle;text-align: center;">
                        <?php if ($value['status_inspection'] != "2" and $value['status_inspection'] != "6") { ?>
                            <?php echo $value['remarks'] ? str_replace("\n", "<br/>", $value['remarks']) : "-"; ?>
                        <?PHP } else { ?>
                            <?php echo $value["client_remarks"] ? $value["client_remarks"] : "-"; ?><?php } ?>
                    </td>
                </tr>
    ...
    <?php $sisa_pending_approve = $count_all_Data - $count_client_approve;  ?>
    <?php $sisa_pending_reject_client = $count_all_Data - $count_client_reject;  ?>
            ...
            <tr>
                <td colspan="16">
                    <table class="table-body" width="100%" style="text-align: left; border-collapse: collapse !important;">
                        <tr>
                            <?php if ($joint_list[0]['company_id'] == 5) { ?>
                            ...
                            <td style="width: 25%; border: none;">
                                <?php
                                if ($count_client_reject > 0 && $joint_list[0]['status_inspection'] >= 5 && $count_pending_client <= 0) {
                                    echo "<b>Rejected By :</b>";
                                } else if ($sisa_pending_approve <= 0 && $joint_list[0]['status_inspection'] >= 5) {
                                    if ($joint_list[0]['add_comment'] == 1) {
                                        echo "<b>Approved By :</b>";
                                    } elseif ($joint_list[0]['add_comment'] == 2) {
                                        echo "<b>Witnessed By :</b>";
                                    } elseif ($joint_list[0]['add_comment'] == 3) {
                        ...
                        <tr>
                            <?php if ($joint_list[0]['company_id'] == 5) { ?>
                                <td style="width: 25%; border: none;">
                                    <img style="width:100px;" src="data:image/png;base64, <?= ($joint_list[0]['ticked_report_date'] == 1 ?  (isset($sign_approval[$joint_list[0]['document_approval_by']]) ? $sign_approval[$joint_list[0]['document_approval_by']] : '') : (isset($sign_approval[$joint_list[0]['requestor']]) ? $sign_approval[$joint_list[0]['requestor']] : ''))  ?>">
                                </td>
                                <td style="width: 25%; border: none;"></td>
                            <?php } ?>
                            <td style="width: 25%; border: none;">
                            ...
                            <td style="width: 25%; border: none;"></td>
                            <td style="width: 25%; border: none;">
                                <?php // if($sisa_pending_approve <= 0){ 
                                ?>
                                <!-- <img  style="width:100px;" src="data:image/png;base64, <?php if (isset($sign_approval[$joint_list[0]['client_inspection_by']])) {
                                                                                                echo $sign_approval[$joint_list[0]['client_inspection_by']];
                                                                                            } ?>"> -->
...
/*			                    	border: 5px solid #555;*/
                                ...
                                <?php else : ?>
                                    <?php if ($count_pending_client <= 0 || $sisa_pending_approve <= 0 || $sisa_pending_reject_client <= 0) { ?>
                        ...
                        <tr>
                            <?php if ($joint_list[0]['company_id'] == 5) { ?>
                                <td style="width: 25%; border: none;">
                                    <?= ($joint_list[0]['ticked_report_date'] == 1 ? (isset($joint_list[0]['document_approval_by']) ? $user_list[$joint_list[0]['document_approval_by']] : '') : (isset($joint_list[0]['requestor']) ?  $user_list[$joint_list[0]['requestor']] : '')) ?>
                                    <br>
                                    <b>______________</b>
                                </td>
                        ...
                        <tr>
                            <?php if ($joint_list[0]['company_id'] == 5) { ?>
                                <td style="width: 25%; border: none;">DATE : <?= isset($joint_list[0]['requestor']) ? date("d M Y", strtotime($joint_list[0]['date_request'])) : ''; ?>
                                </td>
                                <td style="width: 25%; border: none;"></td>
                            <?php } ?>
                            <td style="width: 25%; border: none;">
                            ...
                            <td style="width: 25%; border: none;">
                                DATE :
                                <?php if ($count_pending_client <= 0 || $sisa_pending_approve <= 0 || $sisa_pending_reject_client <= 0) { ?>
                                    <?= isset($joint_list[0]['client_inspection_by']) ? date("d M Y", strtotime($joint_list[0]['client_inspection_date'])) : ''; ?>
                                <?php } ?>
                            </td>
                            <td style="width: 25%; border: none;"></td>
