...
if ($transmittal['project_code'] == 21) {
    $rfi_no_format = $master_report_number_deck[$rfi_client[0]['project_code']][$rfi_client[0]['company_id']][$rfi_client[0]['discipline']][$rfi_client[0]['type_of_module']][$rfi_client[0]['deck_elevation']]['fitup_rfi'] . '' . $transmittal['report_number'];
} else {
    $rfi_no_format = $master_report_number[$rfi_client[0]['project_code']][$rfi_client[0]['company_id']][$rfi_client[0]['discipline']][$rfi_client[0]['type_of_module']]['fitup_rfi'] . '' . $transmittal['report_number'];
}
...
<body>
    ...
    <header>
        ...
        <table border="1px" style="border-collapse: collapse !important;" width="100%">
                ...
                <td style="padding: 5px;vertical-align: middle !important;">
                    <b><?php
                        if ($rfi_client[0]['status_inspection'] <= 3) {
                            ...
                            echo ($rfi_client[0]['ticked_report_date'] == 1 ?
                                date("d F Y", strtotime($max_array_date_document_approval)) :
                                date("d F Y", strtotime($max_transmitted_date))
                            );
                        }
                        ?></b>
                </td>
            ...
            <tr>
                <?php if ($rfi_client[0]['project'] != 21) { ?>
                ...
                <?php } else {  ?>
                    <td style="padding: 5px;vertical-align: middle !important;"><b>SEATRIUM</b></td>
                    <td style="padding: 5px;vertical-align: middle !important;"><b></b></td>
                <?php } ?>
        ...
        foreach ($rfi_client as $key => $value) : ?>
            ...
            <tr>
                ...
                <td colspan="3" style="text-align: center; padding-bottom: 4px; font-size: 10px !important; border-top: none; border-bottom: none;">
                    <?php if(isset($value['point_v2'])) { ?>
                        <?= $area_name_arr_v2[$value['area_v2']] . "," . $location_name_arr_v2[$value['location_v2']] . "," . $point_list_arr_v2[$value['point_v2']] ?>
                    <?php } else { ?>
    ...
    <div style="page-break-inside: avoid;">
        <table border="1px" style="border-collapse: collapse !important;" width="100%">
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;"><b>LEGEND :
            ...
            <tr>
                ...
                ?>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:left; padding-bottom: 4px; font-size: 13px !important;font-weight: bold;">
            ...
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;"><b>INSPECTION
                        EXECUTION
                        RESULT</b></td>
            </tr>
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:left; padding-bottom: 4px; font-size: 13px !important;font-weight: bold;text-align: center;">
                    <input type="checkbox" name="optiona" id="opta" style="font-size: 15pt !important; padding-bottom: 4px;" <?= ($count_client_reject == 0 && $transmittal['status_inspection']>= 5 && $count_pending_client <= 0) ? 'checked' : '' ?> /><span class="checkboxtext">
                        &nbsp;Accepted:&nbsp;
                    </span>
                    <input type="checkbox" name="optiona" id="opta" style="font-size: 15pt !important; padding-bottom: 4px;" <?= $transmittal['status_inspection'] == 9 ? 'checked' : '' ?> /><span class="checkboxtext"> &nbsp;Accepted
                        ...
                        Release With
                        Comments : &nbsp; </span>
                    <input type="checkbox" name="optiona" id="opta" style="font-size: 15pt !important; padding-bottom: 4px;" <?= ($count_client_reject > 0 && $transmittal['status_inspection']>= 5 && $count_pending_client <= 0) ? 'checked' : '' ?> /><span class="checkboxtext"> &nbsp;Rejected
                        :&nbsp; </span>
            ...
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:left; padding-bottom: 4px; font-size: 12px !important;"><b>Comment/Remarks
                        :<br />
        ...
        <td style="text-align:left; padding-bottom: 4px; font-size: 10px !important;">
          <table width="100%"  style="border-collapse: collapse;text-align: center;">
            ...
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 10px !important;"><b>SIGNATURE FOR
                        INSPECTION
                        EXECUTED</b></td>
            </tr>
            ...
            <tr>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="text-align:center; padding-bottom: 4px; font-size: 12px !important;text-align: center;font-weight: bold; width:25%;">
                        DSAW</td>
                <?php } ?>
                <td style="text-align:center; padding-bottom: 4px; font-size: 12px !important;text-align: center;font-weight: bold; width:25%;">
                    CONTRACTOR</td>
            ...
            <tr>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b>
                                <?= $user[$rfi_client[0]['requestor']]['full_name'] ?>
                        </b></td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b>
                ...
                <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b>
                        <?php if ($rfi_client[0]['status_inspection'] >= 5 && $count_pending_client <= 0) { ?>
            ...
            <tr>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
                        <?php 
                            if ($rfi_client[0]['status_inspection'] >= 5 && $count_pending_client <= 0) {
                            echo "<br>";
                        } ?>
                        <img style="width:80px;height:80px;max-height:150px;text-align:center;" src="data:image/png;base64,<?= ($rfi_client[0]['ticked_report_date'] == 1 ? (isset($rfi_client[0]['document_approval_by']) ? $user[$rfi_client[0]['document_approval_by']]['sign_approval'] : '') : (isset($rfi_client[0]['requestor']) ?  $user[$rfi_client[0]['requestor']]['sign_approval'] : '')) ?>">
                    </td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
                        <?php 
                ...
                <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br /> 
                    <?php 
                        ...
                        if ($count_client_reject > 0 && $rfi_client[0]['status_inspection'] >= 5 && $count_pending_client <= 0) {
                            echo "<b>Rejected By :</b>";
                        } else if ($sisa_pending_approve <= 0 && $rfi_client[0]['status_inspection'] >= 5) {
                            if ($rfi_client[0]['add_comment'] == 1) {
                                echo "<b>Approved By :</b>";
                            } elseif ($rfi_client[0]['add_comment'] == 2) {
                                echo "<b>Witnessed By :</b>";
                            } elseif ($rfi_client[0]['add_comment'] == 3) {
...
/*                    		border: 5px solid #555;*/
                    ...
                    <?php else : ?>
                        <?php if (isset($rfi_client[0]['client_inspection_by']) && $rfi_client[0]['status_inspection'] >= 5 && $count_pending_client <= 0) { ?>
            ...
            <tr>
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">Date
                        <?php if (isset($rfi_client[0]['date_request'])) { ?>
                            <b><?php echo @date("d M Y", strtotime($rfi_client[0]['date_request'])); ?></b>
                        <?php } ?>
                    </td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">Date
