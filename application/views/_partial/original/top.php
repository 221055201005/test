					...
					<?php if ($this->permission_cookie[67] == 1) { ?>
						...
						<div class="col-md-auto text-center topbar-menu">
							<div class="btn-group">
								...
								<div class="dropdown-menu" aria-labelledby="fabrication">
									<a class="dropdown-item" href="<?= base_url() . 'ndt_live/transmittal_list' ?>"><i class="fas fa-caret-right"></i> NDT Transmittal</a>
									<!-- <a class="dropdown-item" href="<?= base_url() . 'ndt/bucket_list' ?>"><i class="fas fa-caret-right"></i>
                  NDT Joint List - QC</a> -->
									<!-- <a class="dropdown-item" href="<?= base_url() . 'ndt/bucket_list' ?>"><i class="fas fa-caret-right"></i>
                  NDT Joint List - Vendor </a> -->
									<?php
                    ...
                    <a class="dropdown-item" href="<?= base_url() . 'ndt_live/ndt_list/' . encrypt($ndt_value['ndt_initial']) ?>"><i class="fas fa-caret-right"></i>

												<?= $ndt_value['ndt_description'] ?></a>
											<!-- <a class="dropdown-item" href="<?= base_url() . 'Ndt/ndt_submit_serverside/' . $ndt_value['ndt_initial'] ?>"><i class="fas fa-caret-right"></i>
												<?= $ndt_value['ndt_description'] ?></a> -->
										<?php } else { ?>
											<!-- <a class="dropdown-item" href="<?= base_url() . 'Ndt/ndt_submit_serverside/' . $ndt_value['ndt_initial'] ?>"><i class="fas fa-caret-right"></i>
												<?= $ndt_value['ndt_description'] ?></a> -->
            ...
            <div class="btn-group">
              <a href="<?php echo base_url(); ?>wtr" class="btn btn-flat btn-green-smoe text-white">
                <i class="fas fa-file-word"></i> &nbsp;MWTR
                  ...
                  <!-- <a class="dropdown-item" href="<?php echo base_url(); ?>master/consumable/consumable_list"><i class="fas fa-caret-right"></i> Consumable Lot No. Register</a> -->
								</div>
							</div>
						</div>
					<?php } ?>
