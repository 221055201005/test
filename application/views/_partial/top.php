...
<body style="background-color: whitesmoke;">
  ...
  <nav class="sticky-top py-1 bg-green-smoe container-fluid">
    ...
    <div class="row align-items-center" id="topbar-mobile"></div>
    ...
    <div class="row align-items-center" id="topbar-desktop">
      <div class="col-md">
        <div class="row">
            ...
            <div class="col-md-auto text-center topbar-menu">
              <div class="btn-group">
                ...
                <div class="dropdown-menu" aria-labelledby="fabrication">
                  ...
                  <?php
                  $ndt = $this->db->query("SELECT * FROM master_ndt_type where status_internal = 0 order by id")->result_array();
                  ...
                  ?>
                    ...
                    <?php } elseif (in_array(19, $this->user_cookie[13]) || in_array(21, $this->user_cookie[13])) { ?>
                      <a class="dropdown-item" href="<?= base_url() . 'ndt_live/ndt_list/' . encrypt($ndt_value['ndt_initial']) . '/atc' ?>"><i class="text-seatrium-blue fas fa-caret-right"></i>
                        <?= $ndt_value['ndt_description'] ?></a>
                    <?php   } ?>
                  <?php } ?>
                </div>
          ...
          <?php if ($this->permission_cookie[112] == '1' or $this->permission_cookie[107] == '1' or $this->permission_cookie[117] == '1' or $this->permission_cookie[56] == '1') { ?>
            <div class="col-md-auto text-center topbar-menu">
              <div class="btn-group">
                <a href="#" class="btn btn-flat btn-green-smoe text-white nav-link" id="fabrication" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="fabrication">
                  ...
                  <?php } ?>
                  <?php if ($this->permission_cookie[202] == '1') { ?>
                    <a class="dropdown-item" href="<?php echo base_url(); ?>master/acceptance_criteria/acceptance_criteria_list"><i class="fas fa-caret-right"></i> Acceptance Criteria Register</a>
                  <?php } ?>
