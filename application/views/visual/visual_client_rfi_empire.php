...
<body>
    ...
    <table border="1px" style="border-collapse: collapse !important;" width="100%">
        ...
        <tr>
            <td colspan="22" style="text-align:left; padding-bottom: 4px; padding-left: 4px; font-size: 12px !important;">
                <b>Document Ref
                    :<br>
                    <?php  //  in_array(1, explode(';', $rfi_client[0]['legend_inspection_auth'])) || in_array(2, explode(';', $rfi_client[0]['legend_inspection_auth']))
                    //             ? "
                    ...
                    echo $master_acceptance[$rfi_client[0]['project']][$rfi_client[0]['company_id']][$rfi_client[0]['discipline']][$rfi_client[0]['module']][$rfi_client[0]['type_of_module']][$rfi_client[0]['class']]['visual']['procedure'];
    ...
    <div style="page-break-inside: avoid;">
        <table border="1px" style="border-collapse: collapse !important;" width="100%">
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;"><b>LEGEND : INSPECTION AUTHORITY AS PER ITP</b></td>
            </tr>
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="padding-bottom: 4px; font-size: 13px !important;font-weight: bold;">
                    <table width="100%">
                        <tr>
                            <td><input type="checkbox" <?php if (in_array(1, explode(';', $rfi_client[0]['legend_inspection_auth']))) {
                                                            echo "checked";
                                                        } ?> /> Hold Point</td>
                            <td><input type="checkbox" <?php if (in_array(2, explode(';', $rfi_client[0]['legend_inspection_auth']))) {
                                                            echo "checked";
                                                        } ?> /> Witness</td>
                            <td><input type="checkbox" <?php if (in_array(3, explode(';', $rfi_client[0]['legend_inspection_auth']))) {
                                                            echo "checked";
                                                        } ?> /> Monitoring</td>
                            <td><input type="checkbox" <?php if (in_array(4, explode(';', $rfi_client[0]['legend_inspection_auth']))) {
                                                            echo "checked";
                                                        } ?> /> Review</td>
                        </tr>
                    </table>
    ...
    <table  border="1px" style="border-collapse: collapse !important;" width="100%"> -->
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 12px !important;"><b>INSPECTION EXCECUTION RESULT</b></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:left; padding-bottom: 4px; font-size: 12px !important; min-height: 15px !important">
                    <b>Comment/Remarks :<br /></b>
                    <!-- &nbsp;&nbsp;&nbsp;&nbsp;<?= $transmittal['status_inspection'] == 6 ? $transmittal['client_remarks'] : "" ?> -->
                </td>
            </tr>

            <tr>
                <td colspan="<?php echo ($rfi_client[0]['company_id'] == 5) ? '4' : '3'; ?>" style="text-align:center; padding-bottom: 4px; font-size: 10px !important;"><b>SIGNATURE FOR INSPECTION EXECUTED</b></td>
            </tr>
            <!-- </table>
    <br>
    <table width="100%" border="1px" style="border-collapse: collapse;"> -->
            ...
            <tr>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b><?= $user_sign['requestor']['full_name'] ?></b></td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b><?= $user_sign['inspector']['full_name'] ?></b></td>
                <td style="padding-bottom: 4px; font-size: 10px !important;">NAME <b><?= (isset($rfi_client[0]['inspection_client_by']) && $rfi_client[0]['status_inspection'] >= 5) ? $user_sign['client']['full_name'] : "" ?></b></td>
            ...
            <tr>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
                        <?php
                        if ($sisa_pending_client <= 0 && $rfi_client[0]['status_inspection'] >= 5) {
                            echo "<br>";
                        } ?>
                        <?php if (isset($rfi_client[0]['inspection_by'])) { ?>
                            <img src="data:image/png;base64,<?= $user_sign['requestor']['sign_approval'] ?>" style="width:80px;height:80px;">
                        <?php } ?>
                    </td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
                ...
                <td style="padding-bottom: 4px; font-size: 10px !important;">SIGNATURE<br />
                    <?php if (count($rfi_client[0]) and $rfi_client[0]['status_inspection'] == 6) {
                        echo "<b>Rejected By :</b>";
                    } elseif ($rfi_client[0]['status_inspection'] == 7) {
                    ...
                    <?php
                    // test_var(count($rfi_client[0]) and $rfi_client[0]['status_isnpection'] == 6) 
                    ?>
                    ...
                    <div style="page-break-inside: avoid;">
                        <?php if ($rfi_client[0]['project_code'] == 17) : ?>
                            ...
                            <div class="text-right" style="padding-right: 5px; padding-bottom:3px;">
                                <?php if (isset($rfi_client[0]['inspection_client_by']) && $rfi_client[0]['status_inspection'] >= 5) { ?>
                ...
                <?php if ($rfi_client[0]['company_id'] == 5) { ?>
                    <td style="padding-bottom: 4px; font-size: 10px !important;">Date
                        <?php if (isset($rfi_client[0]['date_request'])) { ?>
                            <b><?php echo date("Y-m-d", strtotime($rfi_client[0]['date_request'])); ?></b>
                        <?php } ?>
                    </td>
                <?php } ?>
                <td style="padding-bottom: 4px; font-size: 10px !important;">Date
