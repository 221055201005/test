      ...
      <div class="col-md-12">
        <div class="card border-0 shadow-sm my-3">
          <div class="card-body">
            ...
            <hr>
            <form action="<?= site_url('visual/preview_update_ecodoc') ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group row">
                    <label for="" class="col-xl-3 col-form-label text-muted"> Template File</label>
                    <div class="col-xl">
                      <a href="<?= site_url('visual/template_file_ecodoc') ?>" class="btn btn-green-smoe text-white"><i class="fas fa-cloud-download-alt"></i> Template File Visual Inspection</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
