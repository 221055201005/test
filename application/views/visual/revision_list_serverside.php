                ...
                <div class="form-group row">
                  ...
                  <div class="col-xl">
                    <select class="form-control" name="status_inspection">
                      <option value="777" <?php echo (@$status_inspection == 777 ? 'selected' : '') ?>>---</option>
                      <option value="1" <?php echo (@$status_inspection == 1 ? 'selected' : '') ?>>Pending Approval</option>
                      <option value="212" <?php echo (@$status_inspection == 212 ? 'selected' : '') ?>>Rejected (History)</option>
                      <option value="2" <?php echo (@$status_inspection == 2 ? 'selected' : '') ?>>Rejected</option>
                      <option value="3" <?php echo (@$status_inspection == 3 ? 'selected' : '') ?>>Approved</option>
                      <option value="4" <?php echo (@$status_inspection == 4 ? 'selected' : '') ?>>Pending by QC</option>
                    </select>
                  </div>
                </div>
              </div>
