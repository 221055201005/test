  ...
  <?php if($reapproval=='reapproval'){ ?>
        <script type="text/javascript">
          $(document).ready(function(){
            ...
            $('.revise').attr('readonly', true);
            $('.revise').addClass('disabled-effect');
          })
        </script>
        <form method="POST" action="<?= base_url('visual/reapproval_inspection') ?>" autocomplete="off" enctype="multipart/form-data">
      <?php } else {?>
        <form method="POST" action="<?= base_url('visual/approval_inspection') ?>" autocomplete="off" enctype="multipart/form-data"> 
    ...
    <div class="col tab-content" id="myTabContent">
      ...
      <?php if($enable_modify!='client'){ ?>
        <?php if($user_permission[40]==1){ //for SMOE Approval ?>
          <div class="btn btn-muted btn-muted-acc col border form-check form-check-inline text-success">
            <label class="form-check-label">
              <input class="form-check-input" type="radio" name="approval" value="3" style="width: 17px; height: 17px">
            <b>Accept All</b></label>
          </div>
          <div class="btn btn-muted btn-muted-rej col border form-check form-check-inline text-danger">
            <label class="form-check-label">
        ...
        <?php } } else { ?>
          ...
          <?php if(($user_cookie[7]==8 OR $user_cookie[7]==1) AND $reoffer!='reoffer'){ ?>
          ...
          <?php if($enable_modify!='client'){ ?>
            <?php if($user_permission[40]==1){ //for SMOE Approval ?>
            <div class="btn btn-muted btn-muted-pen col border form-check form-check-inline text-primary <?= $reapproval=='reapproval' ? 'd-none' : '' ?>">
              <label class="form-check-label">
                <input class="form-check-input" type="radio" name="approval" value="4" style="width: 17px; height: 17px">
    ...
    <?php foreach ($inspection_detail as $key => $value){
      ...
      if(in_array(1, $arr_stat_qc) OR in_array(4, $arr_stat_qc) OR ($revision_detail['status_revise']==3 AND in_array(8, $arr_stat_qc))){
        $button_save_qc = '';
      } else {
        $button_save_qc = 'd-none';
      }
      // test_var($button_save_qc);
    ?>
    <div class="row" name="">
        ...
        <div class="bg-white rounded shadow-sm">
          ...
          <div class=" media text-muted pt-3 mx-3 border-top border-bottom border-gray" id="collapseExample<?= $key ?>" style="margin-bottom: 0cm">
            <div class="container-fluid card card-body">
                ...
                <div class="col-md">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <small>
                        <b>
                          Surveyor Name : <?= $user_list[$value['surveyor_creator']]['full_name'] ?>
                        </b>
                      </small>
                      <?php } ?>
                  </div>
              ...
              <div class="row <?= ($this->user_cookie[8]==1 AND $this->user_cookie[11]==1) ? '' : 'd-none' ?>">

                <div class="col-md-12">
                  <table width="50%">
                    <tr>
                      <td class="font-weight-bold text-muted">- Visual Submission</td>
                    ...
                    <tr>
                      <td class="font-weight-bold text-muted">- Fit-Up Submission</td>
                      <td class="font-weight-bold text-muted">:</td>
                      <td><a target="_blank" href="<?php echo  base_url(); ?>fitup/pdf_files/<?php echo strtr($this->encryption->encrypt($value['project']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['discipline']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['type_of_module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt('marz'),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($fitup_detail[$value['id_joint']]['submission_id']),'+=/', '.-~'); ?>/0"><?= $fitup_detail[$value['id_joint']]['submission_id'] ?></a></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold text-muted">- Fit-Up RFI</td>
                      <td class="font-weight-bold text-muted">:</td>
                      <td><a target="_blank" href="<?php echo  base_url(); ?>fitup/pdf_files_client/<?php echo strtr($this->encryption->encrypt($value['project']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['discipline']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['type_of_module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($fitup_detail[$value['id_joint']]['report_number']),'+=/', '.-~'); ?>"><?= $fitup_detail[$value['id_joint']]['report_number'] ?></a></td>
                    </tr>

                    <?php foreach ($ndt_data[$value['id_visual']] as $value_ndt) { ?>
                    <tr>
                      <td class="font-weight-bold text-muted">- NDT <?= $ndt_master[$value_ndt['ndt_type']] ?></td>
                      <td class="font-weight-bold text-muted">:</td>
                      <td><a target="_blank" href="<?= base_url('ndt/ndt_detail/').$ndt_master[$value_ndt['ndt_type']].'/'.$value['drawing_no'].'/'.$value_ndt['report_number'].'/'.$value_ndt['submission_id'] ?>"><?= $value_ndt['report_number'] ?></a></td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr class="d-none">
                      <td class="font-weight-bold text-muted">- Visual Submission</td>
                      <td class="font-weight-bold text-muted">:</td>
                      <td><a target="_blank" href="<?= base_url('visual/visual_pdf/').$value['submission_id'].'/qc/'.$value['drawing_no'] ?>"><?= $value['submission_id'] ?></a></td>
                    </tr>
                    <tr class="d-none">
                      <td class="font-weight-bold text-muted">- Visual RFI</td>
                      <td class="font-weight-bold text-muted">:</td>
                      <td><a target="_blank" href="<?= base_url('visual/visual_client_rfi/').$value['report_number'].'/client/'.$value['drawing_no'].'/'.$value['postpone_reoffer_no'] ?>"><?= $value['report_number'] ?></a></td>
                    </tr>
                  </table>
                  <br>
                </div>

                <div class="baris d-none">
                  <div class="col-md-12">
                    <label class="label text-muted font-weight-bold">
                      Fit-Up Submission : 
                    </label>
                    <a target="_blank" href="<?php echo  base_url(); ?>fitup/pdf_files/<?php echo strtr($this->encryption->encrypt($value['project']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['discipline']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['type_of_module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt('marz'),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($fitup_detail[$value['id_joint']]['submission_id']),'+=/', '.-~'); ?>/0"><?= $fitup_detail[$value['id_joint']]['submission_id'] ?></a>
                  </div>
                  <div class="col-md-12">
                    <label class="label text-muted font-weight-bold">
                      Fit-Up RFI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                    </label>
                    <a target="_blank" href="<?php echo  base_url(); ?>fitup/pdf_files_client/<?php echo strtr($this->encryption->encrypt($value['project']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['discipline']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($value['type_of_module']),'+=/', '.-~'); ?>/<?php echo strtr($this->encryption->encrypt($fitup_detail[$value['id_joint']]['report_number']),'+=/', '.-~'); ?>"><?= $fitup_detail[$value['id_joint']]['report_number'] ?></a>
                  </div>
                  <!-- <hr> -->
                  <div class="col-md-12">
                    <label class="label text-muted font-weight-bold">
                    ...
                    <a target="_blank" href="<?= base_url('visual/visual_pdf/').$value['submission_id'].'/qc/'.$value['drawing_no'] ?>"><?= $value['submission_id'] ?></a>
                  </div>
                  <div class="col-md-12">
                    <label class="label text-muted font-weight-bold">
                      Visual RFI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: 
                    </label>
                    <a target="_blank" href="<?= base_url('visual/visual_client_rfi/').$value['report_number'].'/client/'.$value['drawing_no'].'/'.$value['postpone_reoffer_no'] ?>"><?= $value['report_number'] ?></a>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    <label>Location</label>
                      ...
                      <?php if($value['location_v2']!=''){ ?>
                        <select name="location_v2[<?= $key ?>]" class="form-control disabled-effect revise" readonly>
                          <option value="">---</option>
                        ...
                        <?php } ?>
                      <?php } else { ?>
                        <select name="location[<?= $key ?>]" class="form-control disabled-effect revise" readonly>
                          <option value="">---</option>
              ...
              <div class="row">
                 <div class="col-md">
                  <div class="form-group">
                    <label>Thk</label>
                      <input type="text" class="form-control" name="thk[1]" value="<?= $joint_list[$value['id_joint']]['thickness'] ?>" required="" disabled="">
                  </div>
                </div>
                <div class="col-md">
                  <div class="form-group">
                    <label>Dia (mm)</label>
                    <input type="text" class="form-control" name="dia[1]" value="<?= $joint_list[$value['id_joint']]['diameter'] ?>" required="" disabled="">
                  </div>
                </div>
                <div class="col-md">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row mx-0">
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        <input type="checkbox" value="1" name="ndt_mt[<?= $key ?>], this" class="custom-control-input" id="customControlAutosizing_mt<?= $key ?>" <?= $value['ndt_mt']==1 ? 'checked' : '' ?>
                          onclick="openFlow('ndt_mt_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_rt_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_pt_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_ut_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_pa_ut_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_ht_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_ft_flow_<?= $key ?>', this)"
                        >
                      ...
                      <div class="form-check col-md-4 custom-control custom-checkbox <?= $enable_modify=='client' ? 'disabled-effect' : '' ?> <?= $value['status_inspection']>=5 ? 'disabled-effect' : '' ?>">
                        ...
                        onclick="openFlow('ndt_pmi_flow_<?= $key ?>', this)"
                        >
                    ...
                    <div class="row">
                      <div class="col-md-7">
                        <label>NDT Requirement Sequence</label>
                        <select class="chooser chooser_<?= $key ?>" style="height: 30px !important" multiple="" name="ndt_sequence[<?= $key ?>][]" 
                          >
                          <?php if($value['status_inspection']>=3){ ?>
                            <?php foreach (explode(';', $value['ndt_sequence']) as $key_sq => $value_seq) { ?>
                              <option value="<?= $value_seq ?>" selected><?= $ndt_master_v2[$value_seq]['ndt_description'] ?></option>
                            <?php } ?>
                          <?php } else { ?>
                            <option value="1" class="ndt_rt_flow_<?= $key ?> sequence_<?= $key ?>_1" <?= $value['ndt_rt']==1 ? '' : 'disabled' ?>>
                              Radiographic Testing
                            </option>
                            <option value="2" class="ndt_mt_flow_<?= $key ?> sequence_<?= $key ?>_2" <?= $value['ndt_mt']==1 ? '' : 'disabled' ?>>  Magnetic Particle Testing
                            </option>
                            <option value="3" class="ndt_ut_flow_<?= $key ?> sequence_<?= $key ?>_3" <?= $value['ndt_ut']==1 ? '' : 'disabled' ?>>
                              Ultrasonic Testing
                            </option>
                            <option value="4" class="ndt_pa_ut_flow_<?= $key ?> sequence_<?= $key ?>_4" <?= $value['ndt_pa_ut']==1 ? '' : 'disabled' ?>>
                              PA Ultrasonic Testing
                            </option>
                            <option value="5" class="ndt_ht_flow_<?= $key ?> sequence_<?= $key ?>_5" <?= $value['ndt_ht']==1 ? '' : 'disabled' ?>>  Hardness Testing
                            </option>
                            <option value="6" class="ndt_ft_flow_<?= $key ?> sequence_<?= $key ?>_6" <?= $value['ndt_ft']==1 ? '' : 'disabled' ?>>Ferrite Testing</option>
                            <option value="7" class="ndt_pt_flow_<?= $key ?> sequence_<?= $key ?>_7" <?= $value['ndt_pt']==1 ? '' : 'disabled' ?>>Penetrant Testing</option>
                            <option value="8" class="ndt_pmi_flow_<?= $key ?> sequence_<?= $key ?>_8" <?= $value['ndt_pmi']==1 ? '' : 'disabled' ?>>Positif Material Testing</option>
                            <option value="9" class="ndt_pwht_flow_<?= $key ?> sequence_<?= $key ?>_9" <?= $value['ndt_pwht']==1 ? '' : 'disabled' ?>>PWHT Testing</option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="col-md-5">
                ...
                <div class="col-md">
                  ...
                  <div class="card col-md">
                    <div class="form-group">
                      ...
                      <br>
                      <?php if($value['qc_inspection_attachment']!=''){ ?>
                        <a href="https://<?= $url_image ?>/pcms_v2_photo/<?= $value['qc_inspection_attachment'] ?>" target="_blank">QC Attachment</a>
                        <span class="btn btn-info" onclick="setSrc_surve('<?= $value['qc_inspection_attachment'] ?>')"><i class="fas fa-camera"></i></span>
                      <?php } else { ?>
                        <input type="file" name="reject_pending_qc_attachment[<?= $key ?>]" class="form-control">
                      <?php } ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md">
                    <div class="form-group">
                      <label>SMOE Inspector Remark</label>
                      <textarea class="form-control" name="inspection_remarks[<?= $key ?>]" <?= $value['status_inspection']==1 ? '' : 'disabled' ?>><?= $value['inspection_remarks'] ?></textarea>
                    </div>
                  </div>

                  <?php if($value['revision_status_inspection']==1){ ?>
                    <div class="col-md">
                      <div class="form-group">
                        <label>Client Remark</label>
                        <textarea value="" class="form-control" name="client_remarksasd[<?= $key ?>]" disabled><?= $value['client_remarks'] ?></textarea>
                      </div>
                    </div>
                  <?php } ?>
              ...
              <div class="my-3 p-3 bg-white rounded shadow-sm" style="margin-top: 0">
                <div class="overflow-auto media text-muted" style="margin-top: 0">
                  <div class="container-fluid text-right p-0" style="margin-top: 0">
                    ...
                    <?php } elseif($value['status_inspection']==433){ ?>
                    ...
                    <?php } elseif($value['status_inspection']==11){ ?>
                      ...
                      <!-- ========================== -->
                    <?php } elseif(($value['status_inspection']==4 OR $value['status_inspection']==1 OR ($revision_detail['status_revise']==3 AND $value['status_inspection']==8)) AND $status_fitup[$value['id_joint']]>=3){ ?>
                      <?php if($user_permission[40]==1){ //for SMOE Approval ?>
                ...
                <div class="overflow-auto media text-muted">
                  <div class="container-fluid text-right p-0">
                    <div class="btn-group_dele" role="group" aria-label="Basic example">
                      ...
                      <?php //} ?>
                      <?php //test_var($allow_revise) ?>
                      <?php if($allow_revise==1 AND !in_array(4, $arr_stat_qc)){ ?>
                        <?php if($user_permission[41]==1){ ?>
                        <?php 
                          $status_inspection_all = array_column($inspection_detail, 'status_inspection'); 
                        ?>
                          <badge name="submit_visual" class="btn btn-warning 
                            <?= 
                              (
                                in_array('5', $status_inspection_all)
                                OR 
                                in_array('6', $status_inspection_all)
                                OR 
                                in_array('7', $status_inspection_all)
                                // in_array('7', $status_inspection_all) 
                                // AND !in_array('11', $status_inspection_all) 
                                // AND !in_array('9', $status_inspection_all) 
                                // AND !in_array('10', $status_inspection_all) 
                                // AND !in_array('6', $status_inspection_all) 
                                // AND !in_array('5', $status_inspection_all)
                              ) 
                              ? 'd-none' 
                              : '' 

                            ?>" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-edit"></i> Request for Update</badge>
                        <?php } ?>
                      <?php } else { ?>
                        <?php if($reapproval=='reapproval'){ ?>
