...
<html><head>
  ...
  <header>  
    ...
    <table width="100%" border="1px" style="border-collapse: collapse !important;">
      <head>
        <tr>
          <td ><b class="tab">EMPLOYER</b>: <?= $master_project[$visual_report[0]['project']]['client'] ?></td>
          <td><b class="tab2">
        ...
        <tr>
          ...
          <td><b class="tab2">DATE</b>: <?php if($visual_report[0]['status_inspection'] <= 3){ echo date("d F Y",strtotime($visual_report[0]['date_request'])); } else { echo date("d F Y",strtotime($show_date)); }; ?></td>
        ...
        <tr>
          <td colspan="2" class="bb bx" width="100%"><center><b>VISUAL INSPECTION REPORT - <?= strtoupper($master_discipline[$visual_report[0]['discipline']]['discipline_name']) ?></b></center></td>
        </tr>
        <tr>
  ...
  <table width="100%" border="0" style="text-align: left;border-collapse: collapse !important;">
    ...
    <tr>
      <td class="ball" style="vertical-align: middle; text-align: center"><?= $no ?></td>
        <td class="ball" style="vertical-align: middle; text-align: center"><?= $value['drawing_wm'].' Rev. '.($value['transmit_wm_rev']!='' ? $value['transmit_wm_rev'] : $value['rev_wm_template']).($master_drawing_wm[$value['drawing_wm']]['client_doc_no']>0 ? ' ('.$master_drawing_wm[$value['drawing_wm']]['client_doc_no'].')' : '') ?></td>
      ...
      <td class="ball" style="vertical-align: middle; text-align: center"><?= $value['sch'] ?></td>
      <td class="ball" style="vertical-align: middle; text-align: center"><?= $value['thickness'] ?></td>

      <td class="ball" style="vertical-align: middle; text-align: center">
        <?= number_format($value['revision']>0 ? $value['length_of_weld'] : $value['weld_length'], 2) ?>    
      </td>
      ...
      <td class="ball" style="vertical-align: middle;"><center><?= str_replace("<", "'<'", $value['remarks']) ?></center></td>    
