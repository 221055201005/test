...
<html>
  ...
  <body>
    <p>Dear All,</b></p>
    <p>The following Email contain <?= $text_invi ?> for Visual Inspection Progress.</p>
        ...
        <td>
          <table style='padding:20px !important;'>
            <tr style='font-weight:bold;'>
              <td>RFI No</td>
              <td>:</td>
              <td><?= $reno_view ?> <?php if(isset($postpone_reoffer_no_val)){ echo "Rev. ".$postpone_reoffer_no_val; } ?></td>
            </tr>
            <tr>
              <td>Report No</td>
              <td>:</td>
            ...
            <tr>
              <td><?= $form_text ?> Date</td>
              <td>:</td>
              <td><?= $inspect_date ?></td>
            </tr>
            <tr>
              <td><?= $form_text ?> Time</td>
              <td>:</td>
              <td><?= $inspect_time ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <a href='<?= $out_link ?>' class='button-9'> Approval </a>
              </td>
            </tr>
            <tr>
              ...
              <td>:</td>
              <td>
                <a href='<?= $smoe_link ?>' class='button-9'> Approval </a>
              </td>
            </tr>
          </table>
        </td>                     
