          ...
          <div class="col-6">
            <div class="form-group row">
              ...
              <div class="col-md">
                ...
                <select class="form-control discipline" name="status" >
                  <option value="">---</option>
                  <option value="0" <?php echo ($this->input->get("status") == "0" ? "selected" : "")  ?>>Draft</option>
                  <option value="1" <?php echo ($this->input->get("status") == "1" ? "selected" : "")  ?>>Pending Approval</option>
