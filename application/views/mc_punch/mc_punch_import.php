    ...
    <div class="col">
      <div class="card shadow my-3 rounded-0">
        <div class="card-header">
          <h6 class="m-0">Import Punch Item</h6>
        </div>
        <div class="card-body bg-white overflow-auto">
          <form method="POST" action="<?php echo base_url(); ?>mc_punch/mc_punch_import_preview" enctype="multipart/form-data">
            <div class="form-group row">
              <label class="col-md-4 col-lg-3 col-form-label font-weight-bold">Template Excel</label>
              <div class="col-xl col-form-label">
                <a target="_blank" href="<?php echo base_url(); ?>/file/mc_punch/mc_punch_import.xlsx?v=<?php echo date("YmdHis") ?>">mc_punch_import.xlsx</a>
              </div>
            </div>
            <div class="form-group row">
