<form id="form_rfi" method="POST" action="<?php echo base_url() ?>mc_punch/mc_punch_rfi_resubmit_process/" enctype="multipart/form-data">
  <?php error_reporting(0) ?>
  <div class="row">
    
    <div class="card-body bg-white">

      <input type="hidden" name="id_punch" value="<?php echo strtr($this->encryption->encrypt($detail_data['id_punch']), '+=/', '.-~') ?>">
