...
use HTML5_ModTokenizer;
use HTML5_ModTreeBuilder;
    ...
    */
    ...
    public function loadHtml($str, $encoding = null)
    {
        ...
        try {
            ...
            if ($this->options->isHtml5ParserEnabled() && class_exists(HTML5_ModTokenizer::class)) {
                $tokenizer = new HTML5_ModTokenizer($str);
                $tokenizer->parse();
                $doc = $tokenizer->save();

                $quirksmode = ($tokenizer->getTree()->getQuirksMode() > HTML5_ModTreeBuilder::NO_QUIRKS);
            } else {
