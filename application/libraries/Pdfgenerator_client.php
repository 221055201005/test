...
class Pdfgenerator_client
{
  public function generate($html,$filename)
  {
    ...
    $canvas->page_text(403, 140, "{PAGE_NUM} of {PAGE_COUNT}", $font, 8, array(0,0,0));
  ...
  public function generate_bnp_potrait($html,$filename)
  {
    define("DOMPDF_ENABLE_HTML5PARSER", true);
    define('DOMPDF_ENABLE_AUTOLOAD', false);
    require_once("vendor/dompdf/dompdf/dompdf_config.inc.php");
    ...
    $canvas->page_text(286, 820, "{PAGE_NUM} of {PAGE_COUNT}", $font, 8, array(0,0,0));
    ob_end_clean();
    $dompdf->stream($filename.'.pdf',array("Attachment"=>0));
  }
}
